...
struct FAnnouncerSequence
{
	...
	TEnumAsByte<AnnouncerExpression_EAnnouncerExpression> InitialExpression_5_486E534E4390A6440396F185650B5A02;      // 0x0028(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	unsigned char                                      UnknownData_NF46[0x7];                                     // 0x0029(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
