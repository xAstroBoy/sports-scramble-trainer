...
// 0x0298 (FullSize[0x05E0] - InheritedSize[0x0348])
...
public:
	...
	TEnumAsByte<Engine_ETimelineDirection>             Timeline_VideoScreenAlpha__Direction_0B067C744AAAC856AEFE539B6C52A68A; // 0x03A4(0x0001) (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	unsigned char                                      UnknownData_LP6V[0x3];                                     // 0x03A5(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	TEnumAsByte<Engine_ETimelineDirection>             Timeline_HideStatic__Direction_254386494A592BD274F5C4960A875DC6; // 0x03B4(0x0001) (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	unsigned char                                      UnknownData_BYP1[0x3];                                     // 0x03B5(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	TEnumAsByte<Engine_ETimelineDirection>             TimelineTransitionAlpha__Direction_D70C10F54E1B29BA17B24CA1F74D4D49; // 0x03C4(0x0001) (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	unsigned char                                      UnknownData_0QYN[0x3];                                     // 0x03C5(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	struct FScriptMulticastDelegate                    VoiceClipComplete;                                         // 0x03D8(0x0010) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, BlueprintAssignable, BlueprintCallable)
	struct FScriptMulticastDelegate                    EyeHideComplete;                                           // 0x03E8(0x0010) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, BlueprintAssignable, BlueprintCallable)
	...
	unsigned char                                      UnknownData_DQKS[0x6];                                     // 0x03FA(0x0006) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	struct FScriptMulticastDelegate                    VoiceClipSequenceComplete;                                 // 0x0400(0x0010) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, BlueprintAssignable, BlueprintCallable)
	bool                                               StartInLogo;                                               // 0x0410(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, ExposeOnSpawn)
	unsigned char                                      UnknownData_ECLI[0x7];                                     // 0x0411(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	TEnumAsByte<AnnouncerExpression_EAnnouncerExpression> Expression;                                                // 0x0428(0x0001) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	unsigned char                                      UnknownData_TDBH[0x7];                                     // 0x0429(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_8TK6[0x4];                                     // 0x04AC(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	struct FScriptMulticastDelegate                    TransformFromLogoComplete;                                 // 0x04B8(0x0010) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, BlueprintAssignable, BlueprintCallable)
	bool                                               UseHubMaterials;                                           // 0x04C8(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, ExposeOnSpawn)
	unsigned char                                      UnknownData_BF6W[0x7];                                     // 0x04C9(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	struct FScriptMulticastDelegate                    PairedSequencesComplete;                                   // 0x04F0(0x0010) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, BlueprintAssignable, BlueprintCallable)
	...
	unsigned char                                      UnknownData_DXC7[0x6];                                     // 0x0542(0x0006) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	TArray<struct FName>                               InitialPairedSequences;                                    // 0x05A0(0x0010) (Edit, BlueprintVisible, ZeroConstructor, ExposeOnSpawn)
	struct FScriptMulticastDelegate                    ExitSequenceComplete;                                      // 0x05B0(0x0010) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, BlueprintAssignable, BlueprintCallable)
	class ACMN_HockeyStick_C*                          Hockey_Stick_2;                                            // 0x05C0(0x0008) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnTemplate, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	TEnumAsByte<AnnouncerLooks_EAnnouncerLooks>        Look;                                                      // 0x05C8(0x0001) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	unsigned char                                      UnknownData_XHY7[0x7];                                     // 0x05C9(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass Announcer_BP.Announcer_BP_C");
		return ptr;
	}
	...
	void ChooseBallType();
	void PlayPairedSequences(TArray<struct FName>* PairedSequences, const struct FScriptDelegate& SequencesCompleteEvent);
	void RemoveAttachements();
	void AttachObjectToHand(TEnumAsByte<AnnouncerAttachments_EAnnouncerAttachments> Attachment);
	void StartLogoTransform(const struct FScriptDelegate& Event);
	void PlayGesture(TEnumAsByte<AnnouncerGestures_EAnnouncerGestures> Gesture, const struct FScriptDelegate& Event);
	void UpdateEnvelope();
	void PlayClipsByNameSequence(TArray<struct FName>* SequenceList);
	void PlayClipByName(const struct FName& SequenceName);
	void SetBallTexture();
	...
	void ChangeExpression(TEnumAsByte<AnnouncerExpression_EAnnouncerExpression> NewExpression);
	...
	void FadeInStatic();
	void UpdateAttachments(TEnumAsByte<AnnouncerAttachments_EAnnouncerAttachments> Attachement);
	void EntryComplete();
	void DoNothin();
	void LevelChanged(const struct FName& NewPrimaryLevel);
	void GeoLevelChanged(const struct FName& NewGeoLevel);
	void PlayBallDropSound();
	void PlayArmsArticulateSound();
	void PlayExitSound();
	void TransformLogoToIdle();
	void PlayAudioAsync();
	void ExecuteUbergraph_Announcer_BP(int EntryPoint);
