...
namespace CG
{
	...
	{
	public:
		class FText                                                Name_6_4E03D7D84315F6883108479F2A94F009;                 // 0x0000(0x0018) Edit, BlueprintVisible
		...
		int32_t                                                    Requirement_27_5614A6134CCA62FEA28D64A0750DAD81;         // 0x0068(0x0004) Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash
