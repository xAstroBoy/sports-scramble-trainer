...
// 0x0168 (FullSize[0x1038] - InheritedSize[0x0ED0])
...
public:
	...
	TEnumAsByte<Engine_ETimelineDirection>             Timeline_GrowTrail__Direction_EAC4699C467D508D7B749B8DFB566EAE; // 0x0EEC(0x0001) (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	unsigned char                                      UnknownData_RJ27[0x3];                                     // 0x0EED(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_3OL9[0x6];                                     // 0x0EFA(0x0006) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_AZBP[0x4];                                     // 0x0F14(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_GKTQ[0x4];                                     // 0x0F44(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_JZCG[0x4];                                     // 0x0F84(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_VTWI[0x4];                                     // 0x0FA4(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	TMap<SportsScramble_EBaseballShotType, class UClass*> TrailMap;                                                  // 0x0FA8(0x0050) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance)
	...
	unsigned char                                      UnknownData_EY63[0x2];                                     // 0x0FFE(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_NGX9[0x3];                                     // 0x1009(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_01FE[0x3];                                     // 0x101D(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass BB_Ball_Base.BB_Ball_Base_C");
		return ptr;
	}
	...
	void PlayDespawnFX();
	void PlaySpawnFX();
	void SetTrail(SportsScramble_EBaseballShotType ShotType);
	...
	void ExecuteUbergraph_BB_Ball_Base(int EntryPoint);
};
