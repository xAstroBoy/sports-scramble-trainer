...
namespace CG
{
	 ...
	 */
	struct ABB_Bomb_C_UserConstructionScript_Params
	{	};

	/**
	 * Function BB_Bomb.BB_Bomb_C.ReceiveBeginPlay
	 */
	struct ABB_Bomb_C_ReceiveBeginPlay_Params
	{	};

	/**
	 * Function BB_Bomb.BB_Bomb_C.ReceiveEndPlay
	 */
	struct ABB_Bomb_C_ReceiveEndPlay_Params
	{
	public:
	 ...
	 */
	struct ABB_Bomb_C_BombHit_Params
	{
	public:
	 ...
	 */
	struct ABB_Bomb_C_BombGrabbed_Params
	{
	public:
		class UObject*                                             WorldContextObject;                                      // 0x0000(0x0008)  (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
		class UScramEventBasePayload*                              Payload;                                                 // 0x0008(0x0008)  (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	 ...
	 */
	struct ABB_Bomb_C_ExecuteUbergraph_BB_Bomb_Params
	{
	public:
