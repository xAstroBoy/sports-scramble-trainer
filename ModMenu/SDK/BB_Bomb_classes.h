...
// 0x0028 (FullSize[0x1060] - InheritedSize[0x1038])
...
public:
	...
	unsigned char                                      UnknownData_O5R3[0x4];                                     // 0x1054(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass BB_Bomb.BB_Bomb_C");
		return ptr;
	}
	...
	void ExecuteUbergraph_BB_Bomb(int EntryPoint);
};
