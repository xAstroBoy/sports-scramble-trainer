...
// 0x0088 (FullSize[0x0608] - InheritedSize[0x0580])
...
public:
	...
	TArray<struct FName>                               PrimaryAudioList;                                          // 0x05A0(0x0010) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance)
	...
	unsigned char                                      UnknownData_SUV6[0x3];                                     // 0x05D1(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	int                                                RegularTargetScore;                                        // 0x05E8(0x0004) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	int                                                GoldTargetBonus;                                           // 0x05EC(0x0004) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	int                                                BonusClearScore;                                           // 0x05F0(0x0004) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	int                                                PatternIndex;                                              // 0x05F4(0x0004) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                               SetIsChanging;                                             // 0x05F8(0x0001) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor)
	unsigned char                                      UnknownData_15GY[0x7];                                     // 0x05F9(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass BB_Challenge_02_DeadEye.BB_Challenge_02_DeadEye_C");
		return ptr;
	}
	...
	void Cleanup();
	void UpdateScoreAndBoard(int AddScore);
	void Launch_A_Ball();
	...
	void Find_Gloves(class AActor* DominantHand, class ABB_Mitt_C* Mitt);
	...
	void Shortcut();
	void ExecuteUbergraph_BB_Challenge_02_DeadEye(int EntryPoint);
};
