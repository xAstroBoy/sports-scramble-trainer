...
public:
	...
	unsigned char                                      UnknownData_SC50[0x7];                                     // 0x0599(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_X3ZM[0x1];                                     // 0x05C7(0x0001) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	TArray<struct FName>                               PairedList;                                                // 0x05C8(0x0010) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance)


	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass BB_Challenge_03_LittleLeague.BB_Challenge_03_LittleLeague_C");
		return ptr;
	}
	...
	void Shortcut();
	void ExecuteUbergraph_BB_Challenge_03_LittleLeague(int EntryPoint);
};
