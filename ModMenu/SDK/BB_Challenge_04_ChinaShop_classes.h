...
// 0x004C (FullSize[0x05CC] - InheritedSize[0x0580])
...
public:
	...
	unsigned char                                      UnknownData_WBKQ[0x3];                                     // 0x05B1(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	int                                                WindowScore;                                               // 0x05C4(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	int                                                LightFixtureScore;                                         // 0x05C8(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, ExposeOnSpawn, HasGetValueTypeHash)


	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass BB_Challenge_04_ChinaShop.BB_Challenge_04_ChinaShop_C");
		return ptr;
	}
	...
	void UpdateBallType();
	void UpdateScoreAndBoard(int Additional_Score);
	void GrabInstrument();
	void SpawnElements();
	void Cleanup();
	...
	void ActorBroken(class ABB_Ball_Base_C* Baseball, int WindowScore);
	void GameLoop();
	...
	void Shortcut();
	void ExecuteUbergraph_BB_Challenge_04_ChinaShop(int EntryPoint);
};
