...
namespace CG
{
	...
	public:
		...
		unsigned char                                              UnknownData_AT27[0x7];                                   // 0x0599(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_2ARL[0x1];                                   // 0x05C7(0x0001) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	public:
		...
		void ExecuteUbergraph_BB_Challenge_05_MinorLeague(int32_t EntryPoint);
