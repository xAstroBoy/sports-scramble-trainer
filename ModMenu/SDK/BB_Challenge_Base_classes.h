...
// 0x00EF (FullSize[0x0580] - InheritedSize[0x0491])
class ABB_Challenge_Base_C : public AChallengeBase_C
{
public:
	unsigned char                                      UnknownData_87W2[0x7];                                     // 0x0491(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_L2QC[0x3];                                     // 0x04C9(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	int                                                ID;                                                        // 0x04CC(0x0004) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	int                                                GameLength;                                                // 0x0508(0x0004) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                               GameOver;                                                  // 0x050C(0x0001) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor)
	TEnumAsByte<GameResult_EGameResult>                ChallengeResult;                                           // 0x050D(0x0001) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	unsigned char                                      UnknownData_KZ6F[0x2];                                     // 0x050E(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	int                                                ScoreFontSize;                                             // 0x0578(0x0004) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	int                                                TimerFontSize;                                             // 0x057C(0x0004) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)


	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass BB_Challenge_Base.BB_Challenge_Base_C");
		return ptr;
	}
	...
	void BB_CHG_UpdateScore(int score);
	void BB_CHG_SpawnSportManagerWithAI(bool Override_Batting_Skill, SportsScramble_EScramSkill Override_Skill);
	void BB_CHG_SwapBatIcon(class UClass* InstrumentClass);
	void BB_CHG_GetBatList();
	void BB_CHG_CalculateEndScore(bool Countdown, int CurrentScore, int TargetScore);
	...
	void BB_CHG_ShowScoreboardAnimation(TEnumAsByte<BB_ScoreboardVideos_EBB_ScoreboardVideos> Animation);
	void BB_CHG_SetScoreMaterialAndFont(int FontSize);
	void BB_CHG_SetScoreVisibility(UMG_ESlateVisibility Visibility);
	void BB_CHG_AttachTrainingScoreboard();
	void SetScoreTimerTime(int Seconds, int FontSize);
	void AttachTopTimer();
	...
	void BB_ShowInstrumentAndBallIcons(TEnumAsByte<BB_ScramIconSetting_EBB_ScramIconSetting> Settings);
	void TriggerAlternateCadence();
	void PlayAsync2D();
	void ExecuteUbergraph_BB_Challenge_Base(int EntryPoint);
};
