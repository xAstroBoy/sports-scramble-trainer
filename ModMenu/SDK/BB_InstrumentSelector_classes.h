...
// 0x00D0 (FullSize[0x0508] - InheritedSize[0x0438])
...
public:
	...
	TEnumAsByte<Engine_ETimelineDirection>             Timeline_0__Direction_B43E4F7E436B2337AE79B5B624A9C3A2;    // 0x0494(0x0001) (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	unsigned char                                      UnknownData_99XG[0x3];                                     // 0x0495(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	int                                                DisplayCount;                                              // 0x04B0(0x0004) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	unsigned char                                      UnknownData_U6WP[0x4];                                     // 0x04B4(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass BB_InstrumentSelector.BB_InstrumentSelector_C");
		return ptr;
	}
	...
	void ExecuteUbergraph_BB_InstrumentSelector(int EntryPoint);
};
