...
namespace CG
{
	 ...
	 * Size -> 0x0098 (FullSize[0x0FC8] - InheritedSize[0x0F30])
	 */
	...
	public:
		...
		ETimelineDirection                                         Grow__Direction_65FADBF8419D91AF5F7C7EB924AC3EB5;        // 0x0F44(0x0001) ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash
		unsigned char                                              UnknownData_V9JY[0x3];                                   // 0x0F45(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		ETimelineDirection                                         Shrink__Direction_363674504D70168F86AFCBBCB534288B;      // 0x0F54(0x0001) ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash
		unsigned char                                              UnknownData_CUXS[0x3];                                   // 0x0F55(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_33WT[0x4];                                   // 0x0F6C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		EScramInstrumentHitPhysics                                 OldHitPhysics;                                           // 0x0F99(0x0001) Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash
		unsigned char                                              UnknownData_99TP[0x6];                                   // 0x0F9A(0x0006) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		unsigned char                                              SFX_SelectedInstrument[0x28];                            // 0x0FA0(0x0028) UNKNOWN PROPERTY: SoftObjectProperty BB_Instrument_Base.BB_Instrument_Base_C.SFX_SelectedInstrument
