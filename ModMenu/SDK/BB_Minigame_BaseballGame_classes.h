...
public:
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass BB_Minigame_BaseballGame.BB_Minigame_BaseballGame_C");
		return ptr;
	}
	...
	void ExecuteUbergraph_BB_Minigame_BaseballGame(int EntryPoint);
};
