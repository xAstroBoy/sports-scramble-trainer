...
// 0x0049 (FullSize[0x0479] - InheritedSize[0x0430])
...
public:
	...
	int                                                MenuSelection;                                             // 0x0450(0x0004) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	int                                                CountdownTimer;                                            // 0x0454(0x0004) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	unsigned char                                      UnknownData_IRFG[0x4];                                     // 0x045C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass BB_Minigame_BattingSmash.BB_Minigame_BattingSmash_C");
		return ptr;
	}
	...
	void ExecuteUbergraph_BB_Minigame_BattingSmash(int EntryPoint);
};
