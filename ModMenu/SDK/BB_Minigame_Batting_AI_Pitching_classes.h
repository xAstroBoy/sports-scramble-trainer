...
public:
	...
	unsigned char                                      UnknownData_67HL[0x7];                                     // 0x0369(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_M6LV[0x4];                                     // 0x03CC(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_QZG8[0x7];                                     // 0x03D9(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass BB_Minigame_Batting_AI_Pitching.BB_Minigame_Batting_AI_Pitching_C");
		return ptr;
	}
	...
	void DelayDestroy();
	void ExecuteUbergraph_BB_Minigame_Batting_AI_Pitching(int EntryPoint);
};
