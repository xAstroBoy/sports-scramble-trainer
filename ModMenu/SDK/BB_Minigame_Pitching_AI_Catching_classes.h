...
public:
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass BB_Minigame_Pitching_AI_Catching.BB_Minigame_Pitching_AI_Catching_C");
		return ptr;
	}
	...
	void DelayDestroy();
	void ExecuteUbergraph_BB_Minigame_Pitching_AI_Catching(int EntryPoint);
};
