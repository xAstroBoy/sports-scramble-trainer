...
public:
	...
	unsigned char                                      UnknownData_O359[0x7];                                     // 0x0379(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass BB_Minigame_Pitching_Fielding.BB_Minigame_Pitching_Fielding_C");
		return ptr;
	}
	...
	void ExecuteUbergraph_BB_Minigame_Pitching_Fielding(int EntryPoint);
};
