...
// 0x0041 (FullSize[0x0BF1] - InheritedSize[0x0BB0])
...
public:
	...
	struct FScriptMulticastDelegate                    BallCaught;                                                // 0x0BE0(0x0010) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, BlueprintAssignable, BlueprintCallable)
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass BB_Mitt.BB_Mitt_C");
		return ptr;
	}
	...
	void NetResetColor();
	void ExecuteUbergraph_BB_Mitt(int EntryPoint);
