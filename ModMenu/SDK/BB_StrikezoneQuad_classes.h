...
// 0x007C (FullSize[0x03A4] - InheritedSize[0x0328])
...
public:
	...
	TEnumAsByte<Engine_ETimelineDirection>             Timeline_ScaleAlt__Direction_4821DA294C6716D5C3A4389006E6F867; // 0x0374(0x0001) (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	unsigned char                                      UnknownData_VF6Y[0x3];                                     // 0x0375(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	TEnumAsByte<Engine_ETimelineDirection>             Timeline_Scale__Direction_9F56809C47582E25DD2131B54B0B3B42; // 0x0384(0x0001) (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	unsigned char                                      UnknownData_X7GA[0x3];                                     // 0x0385(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_U7RY[0x3];                                     // 0x039D(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass BB_StrikezoneQuad.BB_StrikezoneQuad_C");
		return ptr;
	}
	...
	void ExecuteUbergraph_BB_StrikezoneQuad(int EntryPoint);
};
