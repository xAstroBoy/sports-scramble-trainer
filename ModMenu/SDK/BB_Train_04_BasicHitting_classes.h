...
// 0x00BB (FullSize[0x06DB] - InheritedSize[0x0620])
...
public:
	...
	unsigned char                                      UnknownData_DEH9[0x7];                                     // 0x06C9(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass BB_Train_04_BasicHitting.BB_Train_04_BasicHitting_C");
		return ptr;
	}
	...
	void CustomEvent_20();
	void CustomEvent_21();
	void ExecuteUbergraph_BB_Train_04_BasicHitting(int EntryPoint);
};
