...
// 0x0078 (FullSize[0x0698] - InheritedSize[0x0620])
...
public:
	...
	unsigned char                                      UnknownData_8BN0[0x1];                                     // 0x0677(0x0001) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_Y5M1[0x7];                                     // 0x0681(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	TArray<struct FName>                               FinalAnnouncerSequence;                                    // 0x0688(0x0010) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance)


	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass BB_Train_05_BatBreaking.BB_Train_05_BatBreaking_C");
		return ptr;
	}
	...
	void BatSwapped(SportsScramble_EBaseballInstrumentType NewBat);
	void ScorePlayer();
	...
	void CustomEvent_10();
	void CustomEvent_11();
	void ExecuteUbergraph_BB_Train_05_BatBreaking(int EntryPoint);
};
