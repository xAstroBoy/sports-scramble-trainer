...
// 0x020F (FullSize[0x0620] - InheritedSize[0x0411])
class ABB_Train_Base_C : public ATrainingBase_C
{
public:
	unsigned char                                      UnknownData_5G3X[0x7];                                     // 0x0411(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_WLNR[0x7];                                     // 0x0439(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_UYEK[0x7];                                     // 0x04C1(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	int                                                OutfieldTargetScoreAmt;                                    // 0x0528(0x0004) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	unsigned char                                      UnknownData_Z829[0x4];                                     // 0x052C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_MA3M[0x8];                                     // 0x0538(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_8PMT[0x2];                                     // 0x059E(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	TMap<class AActor*, int>                           BounceCounts;                                              // 0x05A0(0x0050) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnTemplate, DisableEditOnInstance)
	...
	TEnumAsByte<GameResult_EGameResult>                TrainingResult;                                            // 0x05F8(0x0001) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	unsigned char                                      UnknownData_CR7M[0x7];                                     // 0x05F9(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_VOB0[0x7];                                     // 0x0611(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	struct FName                                       PrefaceScoreText;                                          // 0x0618(0x0008) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)


	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass BB_Train_Base.BB_Train_Base_C");
		return ptr;
	}
	...
	void BB_GetBattingSide(SportsScramble_EBattingSide* Side);
	void BB_UpdateLargeScoreboardScore(int score, bool Player2);
	...
	void BB_UpdateTrainingScoreboardCount(int score);
	void BB_UpdateTrainingScoreboardScore(int score);
	void BB_CalculateEndScore();
	void SpawnPitchingEquipment_DEPRECATED();
	void ClearScoreboards();
	void Initialize();
	void UserConstructionScript();
	void ShowScoreboardAnimation(TEnumAsByte<BB_ScoreboardVideos_EBB_ScoreboardVideos> Animation);
	void SetScoreMaterialAndFont(int FontSize);
	void SetScoreVisibility(UMG_ESlateVisibility Visibility);
	...
	void BB_OutfieldTargetHit(class AScramBall* Ball, int TargetId);
	...
	void ExecuteUbergraph_BB_Train_Base(int EntryPoint);
};
