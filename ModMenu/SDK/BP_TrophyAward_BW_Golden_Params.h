...
namespace CG
{
	 ...
	 */
	struct ABP_TrophyAward_BW_Golden_C_UserConstructionScript_Params
	{	};

	/**
	 * Function BP_TrophyAward_BW_Golden.BP_TrophyAward_BW_Golden_C.OnStrike
	 */
	struct ABP_TrophyAward_BW_Golden_C_OnStrike_Params
	{
	public:
	 ...
	 */
	struct ABP_TrophyAward_BW_Golden_C_OnGutterBall_Params
	{
	public:
		class ABowlingBall*                                        Ball;                                                    // 0x0000(0x0008)  (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	};
	 ...
	 */
	struct ABP_TrophyAward_BW_Golden_C_ExecuteUbergraph_BP_TrophyAward_BW_Golden_Params
	{
	public:
		int32_t                                                    EntryPoint;                                              // 0x0000(0x0004)  (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
		unsigned char                                              UnknownData_1CBV[0x4];                                   // 0x0004(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY) ()
	};
