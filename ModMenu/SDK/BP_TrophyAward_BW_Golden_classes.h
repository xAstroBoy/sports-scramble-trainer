...
public:
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass BP_TrophyAward_BW_Golden.BP_TrophyAward_BW_Golden_C");
		return ptr;
	}
	...
	void ExecuteUbergraph_BP_TrophyAward_BW_Golden(int EntryPoint);
};
