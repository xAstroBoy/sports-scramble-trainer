...
{
public:
	unsigned char                                      UnknownData_DSLJ[0x7];                                     // 0x0391(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_7K3S[0x7];                                     // 0x03A1(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	int                                                PlayerId;                                                  // 0x03B8(0x0004) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	unsigned char                                      UnknownData_XYRI[0x4];                                     // 0x03BC(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_RG9N[0x7];                                     // 0x03C9(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass BP_TrophyAward_BaseballBase.BP_TrophyAward_BaseballBase_C");
		return ptr;
	}
	...
	void GameEnd(class AScramPlayer* Player, int PlayerId);
	void PitchEvent();
	void WalkEvent();
	void BadPitch();
	void BallEvent();
	void OnHit();
	void ExecuteUbergraph_BP_TrophyAward_BaseballBase(int EntryPoint);
};
