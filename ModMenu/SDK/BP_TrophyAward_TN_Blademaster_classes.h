...
public:
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass BP_TrophyAward_TN_Blademaster.BP_TrophyAward_TN_Blademaster_C");
		return ptr;
	}
	...
	void ExecuteUbergraph_BP_TrophyAward_TN_Blademaster(int EntryPoint);
};
