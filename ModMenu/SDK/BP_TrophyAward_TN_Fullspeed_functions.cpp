...
{
	static auto fn = UObject::FindObject<UFunction>("Function BP_TrophyAward_TN_Fullspeed.BP_TrophyAward_TN_Fullspeed_C.UserConstructionScript");
...
{
	static auto fn = UObject::FindObject<UFunction>("Function BP_TrophyAward_TN_Fullspeed.BP_TrophyAward_TN_Fullspeed_C.DebugEarn");
...
void ABP_TrophyAward_TN_Fullspeed_C::OnHit(class ATennisBall* TennisBall, class ATN_Instrument_Base_C* Instrument, SportsScramble_ETennisBallType BallType)
{
	static auto fn = UObject::FindObject<UFunction>("Function BP_TrophyAward_TN_Fullspeed.BP_TrophyAward_TN_Fullspeed_C.OnHit");
...
void ABP_TrophyAward_TN_Fullspeed_C::ExecuteUbergraph_BP_TrophyAward_TN_Fullspeed(int EntryPoint)
{
	static auto fn = UObject::FindObject<UFunction>("Function BP_TrophyAward_TN_Fullspeed.BP_TrophyAward_TN_Fullspeed_C.ExecuteUbergraph_BP_TrophyAward_TN_Fullspeed");
