...
// 0x0068 (FullSize[0x0B88] - InheritedSize[0x0B20])
...
public:
	...
	TEnumAsByte<Engine_ETimelineDirection>             Timeline_1__Direction_DD286C7B4A21D0ED9D711E9D74337311;    // 0x0B2C(0x0001) (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	unsigned char                                      UnknownData_K156[0x3];                                     // 0x0B2D(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	TEnumAsByte<Engine_ETimelineDirection>             Timeline_0__Direction_DE227CDB4E66B6F16636A28B18C711C4;    // 0x0B3C(0x0001) (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	unsigned char                                      UnknownData_8YNN[0x3];                                     // 0x0B3D(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	TEnumAsByte<Engine_ETimelineDirection>             Scale__Direction_22E6EE6E4FC4110C90496693C7363B80;         // 0x0B4C(0x0001) (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	unsigned char                                      UnknownData_OOPP[0x3];                                     // 0x0B4D(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass BP_TrophyGrabbableBase.BP_TrophyGrabbableBase_C");
		return ptr;
	}
	...
	void Play_Grab_SFX();
	void ExecuteUbergraph_BP_TrophyGrabbableBase(int EntryPoint);
};
