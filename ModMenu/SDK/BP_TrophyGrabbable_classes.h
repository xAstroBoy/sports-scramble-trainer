...
// 0x00B8 (FullSize[0x0C40] - InheritedSize[0x0B88])
...
public:
	...
	TEnumAsByte<Engine_ETimelineDirection>             Timeline_0_0__Direction_B5FAF22A4DFEB85A4A7758BB4FF27E7B;  // 0x0BB4(0x0001) (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	unsigned char                                      UnknownData_H07E[0x3];                                     // 0x0BB5(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_CHQS[0x6];                                     // 0x0BF2(0x0006) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	SportsScramble_EScramSport                         SportType;                                                 // 0x0C24(0x0001) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	unsigned char                                      UnknownData_PXQ6[0x3];                                     // 0x0C25(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	int                                                CurrentProgress;                                           // 0x0C30(0x0004) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	int                                                TrophyRequirement;                                         // 0x0C34(0x0004) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                               respawning;                                                // 0x0C38(0x0001) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor)
	unsigned char                                      UnknownData_1YZX[0x3];                                     // 0x0C39(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass BP_TrophyGrabbable.BP_TrophyGrabbable_C");
		return ptr;
	}
	...
	void GetIntegerRowInDataTable(const struct FName& Name, int* Order);
	void DoRespawn();
	...
	void ExecuteUbergraph_BP_TrophyGrabbable(int EntryPoint);
};
