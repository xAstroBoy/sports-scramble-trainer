...
public:
	...
	class UWidgetComponent*                            Text_and_Line;                                             // 0x0360(0x0008) (BlueprintVisible, ZeroConstructor, InstancedReference, IsPlainOldData, NonTransactional, NoDestructor, HasGetValueTypeHash)
	...
	TEnumAsByte<Engine_ETimelineDirection>             IconRotate__Direction_EB6A0F0E49F517CAD34CA3832400A57F;    // 0x0374(0x0001) (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	unsigned char                                      UnknownData_WDA2[0x3];                                     // 0x0375(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	struct FText                                       TrophyName;                                                // 0x0380(0x0018) (Edit, BlueprintVisible, DisableEditOnInstance)
	...
	struct FText                                       ProgressText;                                              // 0x03A8(0x0018) (Edit, BlueprintVisible, DisableEditOnInstance)


	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass BP_TrophyRoomMonitorDisplay.BP_TrophyRoomMonitorDisplay_C");
		return ptr;
	}
	...
	void HideTrophyInfo();
	void ShowTrophyInfo(const struct FName& TrophyName, const struct FText& Description, bool WasEarned, const struct FString& DateEarned, int Progress, int Requirement);
	void UserConstructionScript();
	void IconRotate__FinishedFunc();
	void IconRotate__UpdateFunc();
	void ReceiveBeginPlay();
	void ExecuteUbergraph_BP_TrophyRoomMonitorDisplay(int EntryPoint);
};
