...
namespace CG
{
	 ...
	 */
	struct ABP_Trophy_BB_Dynasty_C_UserConstructionScript_Params
	{	};

	/**
	 * Function BP_Trophy_BB_Dynasty.BP_Trophy_BB_Dynasty_C.GameEnd
	 */
	struct ABP_Trophy_BB_Dynasty_C_GameEnd_Params
	{
	public:
	 ...
	 */
	struct ABP_Trophy_BB_Dynasty_C_ExecuteUbergraph_BP_Trophy_BB_Dynasty_Params
	{
	public:
		int32_t                                                    EntryPoint;                                              // 0x0000(0x0004)  (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
		unsigned char                                              UnknownData_OXPH[0x4];                                   // 0x0004(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY) ()
	};
