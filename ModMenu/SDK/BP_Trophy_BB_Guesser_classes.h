...
{
public:
	unsigned char                                      UnknownData_A8LN[0x4];                                     // 0x03B4(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	struct FPointerToUberGraphFrame                    UberGraphFrame;                                            // 0x03B8(0x0008) (ZeroConstructor, Transient, DuplicateTransient)


	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass BP_Trophy_BB_Guesser.BP_Trophy_BB_Guesser_C");
		return ptr;
	}
	...
	void DebugEarn();
	void ExecuteUbergraph_BP_Trophy_BB_Guesser(int EntryPoint);
};
