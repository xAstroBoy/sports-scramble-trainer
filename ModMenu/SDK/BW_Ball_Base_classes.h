...
// 0x0181 (FullSize[0x0F01] - InheritedSize[0x0D80])
...
public:
	...
	unsigned char                                      UnknownData_85YS[0x3];                                     // 0x0DA5(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_N5JT[0x4];                                     // 0x0DBC(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_FAJ0[0x4];                                     // 0x0DEC(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_XI1Q[0x4];                                     // 0x0E14(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_2T1G[0x4];                                     // 0x0E44(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_XOI9[0x4];                                     // 0x0E64(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	TMap<SportsScramble_EBowlingThrowType, class UClass*> TrailMap;                                                  // 0x0E78(0x0050) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance)
	...
	unsigned char                                      UnknownData_A2XY[0x3];                                     // 0x0ECD(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_D4LJ[0x4];                                     // 0x0ED4(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_VAMS[0x7];                                     // 0x0EE1(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	struct FScriptMulticastDelegate                    ThrowChanged;                                              // 0x0EE8(0x0010) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, BlueprintAssignable, BlueprintCallable)
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass BW_Ball_Base.BW_Ball_Base_C");
		return ptr;
	}
	...
	void SetTrail(SportsScramble_EBowlingThrowType ThrowType);
	void ClearTrail();
	...
	void ExecuteUbergraph_BW_Ball_Base(int EntryPoint);
