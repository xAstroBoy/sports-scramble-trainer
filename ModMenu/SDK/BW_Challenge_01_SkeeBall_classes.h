...
// 0x0087 (FullSize[0x05C8] - InheritedSize[0x0541])
class ABW_Challenge_01_SkeeBall_C : public ABW_Challenge_Base_C
{
public:
	unsigned char                                      UnknownData_B2Q1[0x7];                                     // 0x0541(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_HNQR[0x7];                                     // 0x0551(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	TArray<struct FName>                               AlternateAudioList;                                        // 0x0580(0x0010) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance)
	...
	unsigned char                                      UnknownData_5KSG[0x5];                                     // 0x0593(0x0005) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass BW_Challenge_01_SkeeBall.BW_Challenge_01_SkeeBall_C");
		return ptr;
	}
	...
	void ExecuteUbergraph_BW_Challenge_01_SkeeBall(int EntryPoint);
};
