...
{
public:
	unsigned char                                      UnknownData_LVUP[0x7];                                     // 0x0541(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	TArray<struct FName>                               PairedList;                                                // 0x0558(0x0010) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance)


	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass BW_Challenge_03_EasyPeesy.BW_Challenge_03_EasyPeesy_C");
		return ptr;
	}
	...
	void ExecuteUbergraph_BW_Challenge_03_EasyPeesy(int EntryPoint);
};
