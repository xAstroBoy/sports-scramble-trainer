...
namespace CG
{
	...
	{
	public:
		unsigned char                                              UnknownData_J2GK[0x7];                                   // 0x0541(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	public:
		...
		void ExecuteUbergraph_BW_Challenge_05_EqualMatch(int32_t EntryPoint);
