...
namespace CG
{
	...
	{
	public:
		unsigned char                                              UnknownData_FD1V[0x7];                                   // 0x0F01(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_JH85[0x4];                                   // 0x0F24(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
