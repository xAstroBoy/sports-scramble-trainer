...
// 0x003C (FullSize[0x0364] - InheritedSize[0x0328])
...
public:
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass BW_Minigame_AiVsAI.BW_Minigame_AiVsAI_C");
		return ptr;
	}
	...
	void DelayDestroy();
	void GameOver();
	void ExecuteUbergraph_BW_Minigame_AiVsAI(int EntryPoint);
};
