...
public:
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass BW_Minigame_Practice.BW_Minigame_Practice_C");
		return ptr;
	}
	...
	void DelayDestroy();
	void ExecuteUbergraph_BW_Minigame_Practice(int EntryPoint);
};
