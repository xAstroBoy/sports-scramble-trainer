...
public:
	...
	unsigned char                                      UnknownData_M3JG[0x7];                                     // 0x0351(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass BW_Multiplayer.BW_Multiplayer_C");
		return ptr;
	}
	...
	void ExecuteUbergraph_BW_Multiplayer(int EntryPoint);
};
