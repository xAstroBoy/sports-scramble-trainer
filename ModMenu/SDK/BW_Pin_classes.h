...
namespace CG
{
	...
	public:
		...
		ETimelineDirection                                         Timeline_Shrink__Direction_D46F3A234E89FD8FB05F328799728497; // 0x0934(0x0001) ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash
		unsigned char                                              UnknownData_1OB4[0x3];                                   // 0x0935(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_4DT7[0x4];                                   // 0x094C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_PRWT[0x7];                                   // 0x0959(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	public:
		...
		void BonusFX(const struct FVector& Location, int32_t ModifiedScore, bool ModifiedBonus);
		void OnKnockedDown();
		void DestroyPrimitive(bool playOut, float Delay);
		void ServerBonusFX(const struct FVector& Location, int32_t ModifiedScore, bool ModifiedBonus);
