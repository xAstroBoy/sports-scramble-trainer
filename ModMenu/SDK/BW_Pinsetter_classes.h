...
// 0x0099 (FullSize[0x03D1] - InheritedSize[0x0338])
...
public:
	...
	TEnumAsByte<Engine_ETimelineDirection>             Timeline_PinReset__Direction_E25840F84F0560C8DE7A2886CF9F7859; // 0x0364(0x0001) (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	unsigned char                                      UnknownData_DQL8[0x3];                                     // 0x0365(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	struct FScriptMulticastDelegate                    PinResetComplete;                                          // 0x0380(0x0010) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, BlueprintAssignable, BlueprintCallable)
	...
	unsigned char                                      UnknownData_RNWL[0x4];                                     // 0x039C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	struct FScriptMulticastDelegate                    PindeckHidden;                                             // 0x03A0(0x0010) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, BlueprintAssignable, BlueprintCallable)
	...
	unsigned char                                      UnknownData_7Z6P[0x4];                                     // 0x03B4(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass BW_Pinsetter.BW_Pinsetter_C");
		return ptr;
	}
	...
	void Initialize();
	void GetRollScore(int* PinsKnockedDown);
	void Cleanup();
	void SpawnAllPins();
	...
	void ClearPins();
	void ExecuteUbergraph_BW_Pinsetter(int EntryPoint);
