...
// BlueprintGeneratedClass BW_ScoreKeeper_BP.BW_ScoreKeeper_BP_C
...
public:
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass BW_ScoreKeeper_BP.BW_ScoreKeeper_BP_C");
		return ptr;
	}
