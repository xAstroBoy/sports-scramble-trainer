...
// 0x005C (FullSize[0x04CE] - InheritedSize[0x0472])
class ABW_Train_01_BasicBowling_Casual_C : public ABW_Train_Base_C
{
public:
	unsigned char                                      UnknownData_NKWT[0x6];                                     // 0x0472(0x0006) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_EZ6P[0x5];                                     // 0x04A3(0x0005) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	SportsScramble_EScramSkill                         OriginalPlayerSkill;                                       // 0x04CC(0x0001) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	SportsScramble_EBowlingEvent                       WhatWasTheBowlingEvent;                                    // 0x04CD(0x0001) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)


	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass BW_Train_01_BasicBowling_Casual.BW_Train_01_BasicBowling_Casual_C");
		return ptr;
	}
	...
	void ExecuteUbergraph_BW_Train_01_BasicBowling_Casual(int EntryPoint);
};
