...
// 0x005B (FullSize[0x04CD] - InheritedSize[0x0472])
class ABW_Train_02_BasicBowling_Standard_C : public ABW_Train_Base_C
{
public:
	unsigned char                                      UnknownData_VR76[0x6];                                     // 0x0472(0x0006) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_Y9O6[0x4];                                     // 0x04A4(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass BW_Train_02_BasicBowling_Standard.BW_Train_02_BasicBowling_Standard_C");
		return ptr;
	}
	...
	void Tutorial_BW_BallReleased(class UObject* WorldContextObject, class UScramEventBasePayload* Payload);
	...
	void CustomEvent_8();
	void CustomEvent_9();
	void ExecuteUbergraph_BW_Train_02_BasicBowling_Standard(int EntryPoint);
};
