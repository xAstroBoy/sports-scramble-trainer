...
// 0x005E (FullSize[0x04D0] - InheritedSize[0x0472])
class ABW_Train_06_BallSpin_C : public ABW_Train_Base_C
{
public:
	unsigned char                                      UnknownData_NBVO[0x6];                                     // 0x0472(0x0006) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_LYTR[0x5];                                     // 0x0493(0x0005) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_B6B1[0x2];                                     // 0x04BE(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	TArray<struct FName>                               FinalAnnouncerSequence;                                    // 0x04C0(0x0010) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance)


	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass BW_Train_06_BallSpin.BW_Train_06_BallSpin_C");
		return ptr;
	}
	...
	void CustomEvent_6();
	void CustomEvent_7();
	void ExecuteUbergraph_BW_Train_06_BallSpin(int EntryPoint);
};
