...
// 0x19BE (FullSize[0x1D16] - InheritedSize[0x0358])
class UBallLauncher_AnimBP_C : public UAnimInstance
{
public:
	unsigned char                                      UnknownData_K6P2[0x8];                                     // 0x0358(0x0008) Fix Super Size
	...
	unsigned char                                      UnknownData_IQ2N[0x2];                                     // 0x1CF6(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	struct FScriptMulticastDelegate                    SpawnAnimComplete;                                         // 0x1CF8(0x0010) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, BlueprintAssignable, BlueprintCallable)
	...
	unsigned char                                      UnknownData_NW5Q[0x2];                                     // 0x1D0E(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	{
		static auto ptr = UObject::FindClass("AnimBlueprintGeneratedClass BallLauncher_AnimBP.BallLauncher_AnimBP_C");
		return ptr;
	}
	...
	void ExecuteUbergraph_BallLauncher_AnimBP(int EntryPoint);
