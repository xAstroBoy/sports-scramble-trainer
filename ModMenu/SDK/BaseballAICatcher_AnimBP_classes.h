...
// 0x0378 (FullSize[0x06D8] - InheritedSize[0x0360])
...
public:
	...
	{
		static auto ptr = UObject::FindClass("AnimBlueprintGeneratedClass BaseballAICatcher_AnimBP.BaseballAICatcher_AnimBP_C");
		return ptr;
	}
	...
	void ExecuteUbergraph_BaseballAICatcher_AnimBP(int EntryPoint);
};
