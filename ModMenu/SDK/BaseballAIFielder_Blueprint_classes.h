...
// 0x005A (FullSize[0x054A] - InheritedSize[0x04F0])
...
public:
	...
	TEnumAsByte<Engine_ETimelineDirection>             Timeline_Spawn__Direction_0C7209B9431ACF2B2711B3A8F961766D; // 0x0524(0x0001) (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	unsigned char                                      UnknownData_4UZ4[0x3];                                     // 0x0525(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	TEnumAsByte<Engine_ETimelineDirection>             Timeline_Despawn__Direction_D5F422FD41BF14FCE64FE983A03A6F50; // 0x0534(0x0001) (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	unsigned char                                      UnknownData_2SX4[0x3];                                     // 0x0535(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass BaseballAIFielder_Blueprint.BaseballAIFielder_Blueprint_C");
		return ptr;
	}
	...
	void DespawnFielder();
	void ExecuteUbergraph_BaseballAIFielder_Blueprint(int EntryPoint);
};
