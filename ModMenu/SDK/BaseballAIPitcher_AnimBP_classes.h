...
// 0x0F48 (FullSize[0x12B8] - InheritedSize[0x0370])
...
public:
	...
	{
		static auto ptr = UObject::FindClass("AnimBlueprintGeneratedClass BaseballAIPitcher_AnimBP.BaseballAIPitcher_AnimBP_C");
		return ptr;
	}
	...
	void ExecuteUbergraph_BaseballAIPitcher_AnimBP(int EntryPoint);
};
