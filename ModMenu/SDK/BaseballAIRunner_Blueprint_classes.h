...
// 0x0058 (FullSize[0x0418] - InheritedSize[0x03C0])
...
public:
	...
	TEnumAsByte<Engine_ETimelineDirection>             Timeline_ScaleDown__Direction_68D97F034192CA35E6CA7290A3B0F3B8; // 0x03E4(0x0001) (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	unsigned char                                      UnknownData_SYD5[0x3];                                     // 0x03E5(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	TEnumAsByte<Engine_ETimelineDirection>             Timeline_ScaleUp__Direction_3721805F4254093B06C8E098411A4011; // 0x03F4(0x0001) (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	unsigned char                                      UnknownData_T96L[0x3];                                     // 0x03F5(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	int                                                NumComplete;                                               // 0x0408(0x0004) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass BaseballAIRunner_Blueprint.BaseballAIRunner_Blueprint_C");
		return ptr;
	}
	...
	void Public_Despawn();
	void ExecuteUbergraph_BaseballAIRunner_Blueprint(int EntryPoint);
};
