...
public:
	...
	unsigned char                                      UnknownData_MTIF[0x7];                                     // 0x0461(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_E8X5[0x4];                                     // 0x0494(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	struct FScriptMulticastDelegate                    LightFixtureHitDetected;                                   // 0x04A8(0x0010) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, BlueprintAssignable, BlueprintCallable)
	...
	unsigned char                                      UnknownData_QEIC[0x3];                                     // 0x04C5(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	struct FScriptMulticastDelegate                    PlayerBrokeLightFixture;                                   // 0x04D0(0x0010) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, BlueprintAssignable, BlueprintCallable)


	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass BaseballPracticeArenaLight.BaseballPracticeArenaLight_C");
		return ptr;
	}
	...
	void ExecuteUbergraph_BaseballPracticeArenaLight(int EntryPoint);
	void PlayerBrokeLightFixture__DelegateSignature(class ABB_Ball_Base_C* Ball, int ScoreAmount);
