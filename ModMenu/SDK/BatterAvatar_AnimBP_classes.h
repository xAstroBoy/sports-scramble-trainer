...
// 0x1078 (FullSize[0x14C8] - InheritedSize[0x0450])
...
public:
	...
	{
		static auto ptr = UObject::FindClass("AnimBlueprintGeneratedClass BatterAvatar_AnimBP.BatterAvatar_AnimBP_C");
		return ptr;
	}
	...
	void ExecuteUbergraph_BatterAvatar_AnimBP(int EntryPoint);
};
