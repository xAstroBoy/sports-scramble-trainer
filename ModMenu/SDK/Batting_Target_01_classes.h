...
// 0x009E (FullSize[0x04BE] - InheritedSize[0x0420])
...
public:
	...
	TEnumAsByte<Engine_ETimelineDirection>             ChangeTargetSize__Direction_D9CDDB3D44C9C1EBFDDBB295ED36D6A0; // 0x0454(0x0001) (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	unsigned char                                      UnknownData_X6RG[0x3];                                     // 0x0455(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	int                                                ScoreAmount;                                               // 0x0468(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	unsigned char                                      UnknownData_N7Q8[0x4];                                     // 0x046C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	struct FScriptMulticastDelegate                    TargetOverlapDetection;                                    // 0x04A0(0x0010) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, BlueprintAssignable, BlueprintCallable)
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass Batting_Target_01.Batting_Target_01_C");
		return ptr;
	}



	void ShowScore(int score, const struct FSlateColor& Color);
	void Initialize();
	...
	void ExecuteUbergraph_Batting_Target_01(int EntryPoint);
