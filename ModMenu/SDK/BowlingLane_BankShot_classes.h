...
// 0x007C (FullSize[0x05A4] - InheritedSize[0x0528])
...
public:
	...
	TArray<int>                                        ScoreValues;                                               // 0x0590(0x0010) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance)
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass BowlingLane_BankShot.BowlingLane_BankShot_C");
		return ptr;
	}
	...
	void ExecuteUbergraph_BowlingLane_BankShot(int EntryPoint);
};
