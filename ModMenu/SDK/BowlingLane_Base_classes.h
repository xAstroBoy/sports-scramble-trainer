...
// 0x0060 (FullSize[0x0528] - InheritedSize[0x04C8])
...
public:
	...
	struct FScriptMulticastDelegate                    LaneSetupComplete;                                         // 0x04F8(0x0010) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, BlueprintAssignable, BlueprintCallable)
	struct FScriptMulticastDelegate                    LaneReadyForSwap;                                          // 0x0508(0x0010) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, BlueprintAssignable, BlueprintCallable)
	bool                                               Player1;                                                   // 0x0518(0x0001) (Edit, BlueprintVisible, Net, ZeroConstructor, IsPlainOldData, NoDestructor, ExposeOnSpawn)
	unsigned char                                      UnknownData_7S5H[0x7];                                     // 0x0519(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass BowlingLane_Base.BowlingLane_Base_C");
		return ptr;
	}
	...
	void LR_AddScore(class AActor* Instigator, int AddedScore);
	void Multi_AddScore(class AActor* Instigator, int AddedScore);
	void Server_AddScore(class AActor* Instigator, int AddedScore);
	void Local_AddScore(class AActor* Instigator, int AddedScore);
	void ExecuteUbergraph_BowlingLane_Base(int EntryPoint);
