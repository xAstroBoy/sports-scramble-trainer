...
namespace CG
{
	...
	{
	public:
		unsigned char                                              UnknownData_U69D[0x8];                                   // 0x0588(0x0008) Fix Super Size
		...
		int32_t                                                    NumSegments;                                             // 0x05C0(0x0004) Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic
		...
		int32_t                                                    SolverIterations;                                        // 0x05C8(0x0004) Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic
		...
		unsigned char                                              UnknownData_7ECU[0x2];                                   // 0x05CE(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		int32_t                                                    NumSides;                                                // 0x05E8(0x0004) Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic
		...
		unsigned char                                              UnknownData_658E[0x20];                                  // 0x05F0(0x0020) MISSED OFFSET (PADDING)
