...
namespace CG
{
	...
	public:
		...
		ETimelineDirection                                         Rise__Direction_B75F8614462B5D3B625F32B38FFCFB27;        // 0x039C(0x0001) ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash
		unsigned char                                              UnknownData_6QEK[0x3];                                   // 0x039D(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_06MV[0x3];                                   // 0x03AD(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	public:
		...
		void RiseUp();
		void LowerDown();
		void ExecuteUbergraph_CenterReturnWall(int32_t EntryPoint);
