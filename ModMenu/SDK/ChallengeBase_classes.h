...
// 0x0149 (FullSize[0x0491] - InheritedSize[0x0348])
...
public:
	...
	struct FScriptMulticastDelegate                    ChallengeLevelComplete;                                    // 0x0388(0x0010) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, BlueprintAssignable, BlueprintCallable)
	...
	struct FText                                       InstructionalText01;                                       // 0x03C0(0x0018) (Edit, BlueprintVisible, DisableEditOnInstance)
	struct FText                                       InstructionalText02;                                       // 0x03D8(0x0018) (Edit, BlueprintVisible, DisableEditOnInstance)
	...
	int                                                TargetScore;                                               // 0x03F8(0x0004) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	int                                                CurrentScore;                                              // 0x03FC(0x0004) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	TArray<struct FName>                               AnnouncerAudioList;                                        // 0x0400(0x0010) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance)
	...
	unsigned char                                      UnknownData_J9RI[0x7];                                     // 0x0411(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_M6FF[0x4];                                     // 0x042C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_J2MI[0x7];                                     // 0x0441(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_875T[0x7];                                     // 0x0451(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	TEnumAsByte<TN_RuleTypes_ETN_RuleTypes>            Save_TN_SF_Ruleset;                                        // 0x046C(0x0001) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	unsigned char                                      UnknownData_4K6L[0x3];                                     // 0x046D(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	int                                                Save_TN_SF_GamesToWin;                                     // 0x0470(0x0004) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	TEnumAsByte<TN_RuleTypes_ETN_RuleTypes>            Save_BW_SF_Ruleset;                                        // 0x0477(0x0001) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	unsigned char                                      UnknownData_9NC1[0x1];                                     // 0x047B(0x0001) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	int                                                Save_BB_FilterStrikeoutCount;                              // 0x047C(0x0004) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	int                                                Save_BB_FilterWalkCount;                                   // 0x0480(0x0004) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	int                                                Save_BB_FilterInnings;                                     // 0x0484(0x0004) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	int                                                Save_TN_SF_PointsToWin;                                    // 0x0488(0x0004) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	SportsScramble_EDifficulty                         Save_TN_SF_AI_Difficulty;                                  // 0x048C(0x0001) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	SportsScramble_EDifficulty                         Save_BW_SF_AI_Difficulty;                                  // 0x048D(0x0001) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	SportsScramble_EDifficulty                         Save_BB_AI_Difficulty;                                     // 0x048E(0x0001) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	SportsScramble_EDifficulty                         Challenge_AI_Difficulty;                                   // 0x048F(0x0001) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass ChallengeBase.ChallengeBase_C");
		return ptr;
	}
	...
	void BB_SpawnScrambleIcon(TEnumAsByte<BB_ScramIconSetting_EBB_ScramIconSetting> Settings);
	void AwardTrophy_(int CurrentScore);
	void SpawnAnnouncerPaired(TArray<struct FName>* AnnouncerPairedList);
	void VerifyNotMultiplayerGame(bool* NotMultiplayer);
	void BW_SpawnScrambleIcon();
	void DestroyPopupInfo();
	void DemoDisplayInfo(float Display_Time, const struct FText& Display_Text);
	...
	void HandleSuccess(int CurrentScore);
	void HandleFailure();
	...
	void ExecuteUbergraph_ChallengeBase(int EntryPoint);
