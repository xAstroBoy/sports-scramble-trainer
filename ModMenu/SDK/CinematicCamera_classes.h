...
public:
	...
	unsigned char                                      UnknownData_5B9R[0x2];                                     // 0x0336(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
public:
	...
	unsigned char                                      UnknownData_MWZI[0x3];                                     // 0x032D(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
public:
	...
	unsigned char                                      UnknownData_NUQQ[0x10];                                    // 0x0870(0x0010) MISSED OFFSET (PADDING)
...
// 0x00C0 (FullSize[0x0850] - InheritedSize[0x0790])
...
public:
	...
	unsigned char                                      UnknownData_TMNC[0x4];                                     // 0x07B4(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_XUCM[0xC];                                     // 0x07FC(0x000C) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	struct FString                                     DefaultFilmbackPresetName;                                 // 0x0828(0x0010) (ZeroConstructor, Config, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	struct FString                                     DefaultLensPresetName;                                     // 0x0838(0x0010) (ZeroConstructor, Config, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
