...
struct FClothLODData
{
	...
	unsigned char                                      UnknownData_Z6R1[0x20];                                    // 0x00D8(0x0020) MISSED OFFSET (PADDING)
...
struct FClothConfig
{
	...
	unsigned char                                      UnknownData_66BF[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_0DUV[0x3];                                     // 0x00BD(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FClothParameterMask_PhysMesh
{
	...
	unsigned char                                      UnknownData_4O76[0x3];                                     // 0x0009(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_8EHJ[0x4];                                     // 0x0014(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_4EAU[0x7];                                     // 0x0029(0x0007) MISSED OFFSET (PADDING)
