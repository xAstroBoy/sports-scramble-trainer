...
// BlueprintGeneratedClass CubbyEffect.CubbyEffect_C
...
public:
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass CubbyEffect.CubbyEffect_C");
		return ptr;
	}



	void _ToggleLights(bool isOn);
	void UserConstructionScript();
	void ReceiveBeginPlay();
	void ExecuteUbergraph_CubbyEffect(int EntryPoint);
};
