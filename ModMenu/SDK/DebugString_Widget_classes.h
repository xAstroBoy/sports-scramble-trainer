...
// WidgetBlueprintGeneratedClass DebugString_Widget.DebugString_Widget_C
...
public:
	...
	{
		static auto ptr = UObject::FindClass("WidgetBlueprintGeneratedClass DebugString_Widget.DebugString_Widget_C");
		return ptr;
	}
