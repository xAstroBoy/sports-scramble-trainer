...
// 0x008E (FullSize[0x03B6] - InheritedSize[0x0328])
...
public:
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass FloorLightUpGroup.FloorLightUpGroup_C");
		return ptr;
	}
	...
	void ExecuteUbergraph_FloorLightUpGroup(int EntryPoint);
};
