...
public:
	...
	TEnumAsByte<Engine_ETimelineDirection>             TimelineScale__Direction_83EA0ADE467046AE00C88F9DB661EE87; // 0x0344(0x0001) (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	unsigned char                                      UnknownData_2INY[0x3];                                     // 0x0345(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass FloorLightUp.FloorLightUp_C");
		return ptr;
	}
	...
	void Show();
	void Hide();
	void ExecuteUbergraph_FloorLightUp(int EntryPoint);
};
