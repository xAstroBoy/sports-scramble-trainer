...
{
public:
	unsigned char                                      UnknownData_FD4Z[0x8];                                     // 0x0028(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_3EP3[0x8];                                     // 0x0050(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	int                                                StartFrame;                                                // 0x0058(0x0004) (BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	int                                                EndFrame;                                                  // 0x005C(0x0004) (BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
...
public:
	...
	unsigned char                                      UnknownData_K6HS[0x4];                                     // 0x003C(0x0004) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_SHWM[0x8];                                     // 0x0038(0x0008) MISSED OFFSET (PADDING)
...
// 0x0058 (FullSize[0x05E0] - InheritedSize[0x0588])
...
public:
	...
	unsigned char                                      UnknownData_UQ23[0x2];                                     // 0x0592(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	int                                                NumTracks;                                                 // 0x059C(0x0004) (Edit, ZeroConstructor, EditConst, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	...
	unsigned char                                      UnknownData_UR6N[0x30];                                    // 0x05A4(0x0030) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_6V08[0x7];                                     // 0x05D9(0x0007) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_2X21[0x2C];                                    // 0x002C(0x002C) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_2SU2[0x24];                                    // 0x005C(0x0024) MISSED OFFSET (PADDING)
...
// 0x0130 (FullSize[0x0188] - InheritedSize[0x0058])
...
public:
	...
	unsigned char                                      UnknownData_IRVV[0x120];                                   // 0x0060(0x0120) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_E8Z3[0x4];                                     // 0x0184(0x0004) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_KF4I[0xA8];                                    // 0x0058(0x00A8) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_CRTD[0xA8];                                    // 0x0058(0x00A8) MISSED OFFSET (PADDING)
