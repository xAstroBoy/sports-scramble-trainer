...
{
    /**
     * BlueprintGeneratedClass /Game/Blueprints/Minigames/Baseball/BB_Minigame_Pitching_AI_Catching.BB_Minigame_Pitching_AI_Catching_C
     * Size -> 0x0040 (FullSize[0x0368] - InheritedSize[0x0328])
     */
    class ABB_Minigame_Pitching_AI_Catching_C : public Engine::AActor
    {
    public:
    ...
    public:
        ...
        static inline CoreUObject::UClass* StaticClass()
        {
            ...
            if (!ptr)
                ptr = CoreUObject::UObject::FindClass("BlueprintGeneratedClass /Game/Blueprints/Minigames/Baseball/BB_Minigame_Pitching_AI_Catching.BB_Minigame_Pitching_AI_Catching_C");
            return ptr;
        }
    };
}
