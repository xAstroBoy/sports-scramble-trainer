...
{
    /**
     * BlueprintGeneratedClass /Game/Blueprints/Minigames/Bowling/BW_Minigame_AiVsAI.BW_Minigame_AiVsAI_C
     * Size -> 0x003C (FullSize[0x0364] - InheritedSize[0x0328])
     */
    class ABW_Minigame_AiVsAI_C : public Engine::AActor
    {
    public:
        ...
        ScramSportManagerBowling_Blueprint::AScramSportManagerBowling_Blueprint_C* Manager;                                                 //  Edit, BlueprintVisible, ZeroConstructor, DisableEditOnTemplate, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash
        float                                                        OldWorldToMetersScale;                                   //  Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash
    ...
    public:
        ...
        static inline CoreUObject::UClass* StaticClass()
        {
            ...
            if (!ptr)
                ptr = CoreUObject::UObject::FindClass("BlueprintGeneratedClass /Game/Blueprints/Minigames/Bowling/BW_Minigame_AiVsAI.BW_Minigame_AiVsAI_C");
            return ptr;
        }
    };
}
