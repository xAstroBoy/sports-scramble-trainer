...
{
    /**
     * BlueprintGeneratedClass /Game/Blueprints/Minigames/Bowling/BW_Minigame_HumanVsAI.BW_Minigame_HumanVsAI_C
     * Size -> 0x0038 (FullSize[0x0360] - InheritedSize[0x0328])
     */
    class ABW_Minigame_HumanVsAI_C : public Engine::AActor
    {
    public:
    ...
    public:
        ...
        static inline CoreUObject::UClass* StaticClass()
        {
            ...
            if (!ptr)
                ptr = CoreUObject::UObject::FindClass("BlueprintGeneratedClass /Game/Blueprints/Minigames/Bowling/BW_Minigame_HumanVsAI.BW_Minigame_HumanVsAI_C");
            return ptr;
        }
    };
}
