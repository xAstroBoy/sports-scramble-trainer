...
{
    /**
     * BlueprintGeneratedClass /Game/Blueprints/Sports/Bowling/Lanes/BowlingLane_ConveyorLeft.BowlingLane_ConveyorLeft_C
     * Size -> 0x0038 (FullSize[0x0560] - InheritedSize[0x0528])
     */
    class ABowlingLane_ConveyorLeft_C : public BowlingLane_Base::ABowlingLane_Base_C
    {
    public:
    ...
    public:
        ...
        void ExecuteUbergraph_BowlingLane_ConveyorLeft(int32_t EntryPoint);
        static inline CoreUObject::UClass* StaticClass()
        {
            static CoreUObject::UClass* ptr = nullptr;
            if (!ptr)
                ptr = CoreUObject::UObject::FindClass("BlueprintGeneratedClass /Game/Blueprints/Sports/Bowling/Lanes/BowlingLane_ConveyorLeft.BowlingLane_ConveyorLeft_C");
            return ptr;
        }
    };
}
