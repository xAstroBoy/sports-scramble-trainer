...
{
    /**
     * BlueprintGeneratedClass /Game/Blueprints/Demo/DemoTargetTraining.DemoTargetTraining_C
     * Size -> 0x00B8 (FullSize[0x03E0] - InheritedSize[0x0328])
     */
    class ADemoTargetTraining_C : public Engine::AActor
    {
    public:
        ...
        BasicTypes::TArray<BallTarget_NW::ABallTarget_NW_C*>         Targets;                                                 //  Edit, BlueprintVisible, ZeroConstructor, DisableEditOnTemplate, DisableEditOnInstance
        BasicTypes::TArray<Engine::AActor*>                          VisibleTargets;                                          //  Edit, BlueprintVisible, ZeroConstructor, DisableEditOnTemplate, DisableEditOnInstance

    public:
        void AddActorToGameElementList(Engine::AActor* Actor, bool* Callback);
        void Shutdown(bool* ShutdownBegun);
        void UpdateTargetAnimSpeed(float Speed);
        ...
        void SpeedUp();
        void SpeedUpTimer();
        void TargetShrinking(Engine::AActor* TargetActor);
        void ExecuteUbergraph_DemoTargetTraining(int32_t EntryPoint);
        void GameComplete__DelegateSignature(int32_t score);
        static inline CoreUObject::UClass* StaticClass()
        {
            static CoreUObject::UClass* ptr = nullptr;
            if (!ptr)
                ptr = CoreUObject::UObject::FindClass("BlueprintGeneratedClass /Game/Blueprints/Demo/DemoTargetTraining.DemoTargetTraining_C");
            return ptr;
        }
    };
}
