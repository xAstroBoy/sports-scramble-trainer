...
namespace CG::Engine
{
     ...
     */
    class UInterpTrackInstParticleReplay : public Engine::UInterpTrackInst
    {
    public:
    ...
    public:
        static inline CoreUObject::UClass* StaticClass()
        {
            ...
            if (!ptr)
                ptr = CoreUObject::UObject::FindClass("Class /Script/Engine.InterpTrackInstParticleReplay");
            return ptr;
        }
    };
}
