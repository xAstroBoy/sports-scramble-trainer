...
namespace CG::Engine
{
     ...
     */
    class UInterpTrackVectorBase : public Engine::UInterpTrack
    {
    public:
        CoreUObject::FInterpCurveVector                              VectorTrack;                                             //  ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPublic
    ...
    public:
        static inline CoreUObject::UClass* StaticClass()
        {
            ...
            if (!ptr)
                ptr = CoreUObject::UObject::FindClass("Class /Script/Engine.InterpTrackVectorBase");
            return ptr;
        }
    };
}
