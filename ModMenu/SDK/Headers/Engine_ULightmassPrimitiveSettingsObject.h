...
namespace CG::Engine
{
     ...
     */
    class ULightmassPrimitiveSettingsObject : public CoreUObject::UObject
    {
    public:
    ...
    public:
        static inline CoreUObject::UClass* StaticClass()
        {
            ...
            if (!ptr)
                ptr = CoreUObject::UObject::FindClass("Class /Script/Engine.LightmassPrimitiveSettingsObject");
            return ptr;
        }
    };
}
