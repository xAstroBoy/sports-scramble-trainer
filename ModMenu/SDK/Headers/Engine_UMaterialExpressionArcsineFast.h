...
namespace CG::Engine
{
     ...
     */
    class UMaterialExpressionArcsineFast : public Engine::UMaterialExpression
    {
    public:
    ...
    public:
        static inline CoreUObject::UClass* StaticClass()
        {
            ...
            if (!ptr)
                ptr = CoreUObject::UObject::FindClass("Class /Script/Engine.MaterialExpressionArcsineFast");
            return ptr;
        }
    };
}
