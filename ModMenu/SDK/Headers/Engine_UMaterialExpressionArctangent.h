...
namespace CG::Engine
{
     ...
     */
    class UMaterialExpressionArctangent : public Engine::UMaterialExpression
    {
    public:
    ...
    public:
        static inline CoreUObject::UClass* StaticClass()
        {
            ...
            if (!ptr)
                ptr = CoreUObject::UObject::FindClass("Class /Script/Engine.MaterialExpressionArctangent");
            return ptr;
        }
    };
}
