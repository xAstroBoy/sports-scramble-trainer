...
namespace CG::Engine
{
     ...
     */
    class UMaterialExpressionArctangentFast : public Engine::UMaterialExpression
    {
    public:
    ...
    public:
        static inline CoreUObject::UClass* StaticClass()
        {
            ...
            if (!ptr)
                ptr = CoreUObject::UObject::FindClass("Class /Script/Engine.MaterialExpressionArctangentFast");
            return ptr;
        }
    };
}
