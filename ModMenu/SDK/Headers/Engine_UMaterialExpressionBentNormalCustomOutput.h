...
namespace CG::Engine
{
     ...
     */
    class UMaterialExpressionBentNormalCustomOutput : public Engine::UMaterialExpressionCustomOutput
    {
    public:
    ...
    public:
        static inline CoreUObject::UClass* StaticClass()
        {
            ...
            if (!ptr)
                ptr = CoreUObject::UObject::FindClass("Class /Script/Engine.MaterialExpressionBentNormalCustomOutput");
            return ptr;
        }
    };
}
