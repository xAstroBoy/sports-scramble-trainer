...
namespace CG::Engine
{
     ...
     */
    class UMaterialExpressionDotProduct : public Engine::UMaterialExpression
    {
    public:
    ...
    public:
        static inline CoreUObject::UClass* StaticClass()
        {
            ...
            if (!ptr)
                ptr = CoreUObject::UObject::FindClass("Class /Script/Engine.MaterialExpressionDotProduct");
            return ptr;
        }
    };
}
