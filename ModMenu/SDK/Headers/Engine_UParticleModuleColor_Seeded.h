...
#include "Engine_UParticleModuleColor.h"
...
namespace CG::Engine
{
     ...
     */
    class UParticleModuleColor_Seeded : public Engine::UParticleModuleColor
    {
    public:
    ...
    public:
        static inline CoreUObject::UClass* StaticClass()
        {
            ...
            if (!ptr)
                ptr = CoreUObject::UObject::FindClass("Class /Script/Engine.ParticleModuleColor_Seeded");
            return ptr;
        }
    };
}
