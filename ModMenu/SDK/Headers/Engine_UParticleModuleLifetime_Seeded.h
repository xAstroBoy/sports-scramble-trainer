...
#include "Engine_UParticleModuleLifetime.h"
...
namespace CG::Engine
{
     ...
     */
    class UParticleModuleLifetime_Seeded : public Engine::UParticleModuleLifetime
    {
    public:
    ...
    public:
        static inline CoreUObject::UClass* StaticClass()
        {
            ...
            if (!ptr)
                ptr = CoreUObject::UObject::FindClass("Class /Script/Engine.ParticleModuleLifetime_Seeded");
            return ptr;
        }
    };
}
