...
#include "Engine_UParticleModuleMeshRotation.h"
...
namespace CG::Engine
{
     ...
     */
    class UParticleModuleMeshRotation_Seeded : public Engine::UParticleModuleMeshRotation
    {
    public:
    ...
    public:
        static inline CoreUObject::UClass* StaticClass()
        {
            ...
            if (!ptr)
                ptr = CoreUObject::UObject::FindClass("Class /Script/Engine.ParticleModuleMeshRotation_Seeded");
            return ptr;
        }
    };
}
