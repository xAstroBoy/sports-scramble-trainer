...
#include "Engine_UParticleModuleRotation.h"
...
namespace CG::Engine
{
     ...
     */
    class UParticleModuleRotation_Seeded : public Engine::UParticleModuleRotation
    {
    public:
    ...
    public:
        static inline CoreUObject::UClass* StaticClass()
        {
            ...
            if (!ptr)
                ptr = CoreUObject::UObject::FindClass("Class /Script/Engine.ParticleModuleRotation_Seeded");
            return ptr;
        }
    };
}
