...
namespace CG::OnlineSubsystemOculus
{
     ...
     */
    class UOculusCreateSessionCallbackProxy : public Engine::UOnlineBlueprintCallProxyBase
    {
    public:
    ...
    public:
        OnlineSubsystemOculus::UOculusCreateSessionCallbackProxy* STATIC_CreateSession(int32_t PublicConnections, const BasicTypes::FString& OculusMatchmakingPool);
        static inline CoreUObject::UClass* StaticClass()
        {
            static CoreUObject::UClass* ptr = nullptr;
            if (!ptr)
                ptr = CoreUObject::UObject::FindClass("Class /Script/OnlineSubsystemOculus.OculusCreateSessionCallbackProxy");
            return ptr;
        }
    };
}
