...
namespace CG::OnlineSubsystemOculus
{
     ...
     */
    class UOculusFindSessionsCallbackProxy : public Engine::UOnlineBlueprintCallProxyBase
    {
    public:
    ...
    public:
        OnlineSubsystemOculus::UOculusFindSessionsCallbackProxy* STATIC_FindModeratedSessions(int32_t MaxResults);
        OnlineSubsystemOculus::UOculusFindSessionsCallbackProxy* STATIC_FindMatchmakingSessions(int32_t MaxResults, const BasicTypes::FString& OculusMatchmakingPool);
        static inline CoreUObject::UClass* StaticClass()
        {
            static CoreUObject::UClass* ptr = nullptr;
            if (!ptr)
                ptr = CoreUObject::UObject::FindClass("Class /Script/OnlineSubsystemOculus.OculusFindSessionsCallbackProxy");
            return ptr;
        }
    };
}
