...
namespace CG::OnlineSubsystemOculus
{
     ...
     */
    class UOculusUpdateSessionCallbackProxy : public Engine::UOnlineBlueprintCallProxyBase
    {
    public:
    ...
    public:
        OnlineSubsystemOculus::UOculusUpdateSessionCallbackProxy* STATIC_SetSessionEnqueue(bool bShouldEnqueueInMatchmakingPool);
        static inline CoreUObject::UClass* StaticClass()
        {
            static CoreUObject::UClass* ptr = nullptr;
            if (!ptr)
                ptr = CoreUObject::UObject::FindClass("Class /Script/OnlineSubsystemOculus.OculusUpdateSessionCallbackProxy");
            return ptr;
        }
    };
}
