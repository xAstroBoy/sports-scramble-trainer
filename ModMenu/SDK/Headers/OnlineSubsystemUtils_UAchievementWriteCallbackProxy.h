...
namespace CG::OnlineSubsystemUtils
{
    ...
    public:
        OnlineSubsystemUtils::UAchievementWriteCallbackProxy* STATIC_WriteAchievementProgress(CoreUObject::UObject* WorldContextObject, Engine::APlayerController* PlayerController, const BasicTypes::FName& AchievementName, float Progress, int32_t UserTag);
