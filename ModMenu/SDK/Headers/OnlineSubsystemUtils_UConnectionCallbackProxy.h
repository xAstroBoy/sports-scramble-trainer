...
namespace CG::OnlineSubsystemUtils
{
    ...
    public:
        OnlineSubsystemUtils::UConnectionCallbackProxy* STATIC_ConnectToService(CoreUObject::UObject* WorldContextObject, Engine::APlayerController* PlayerController);
