...
namespace CG::OnlineSubsystemUtils
{
    ...
    public:
        OnlineSubsystemUtils::UEndTurnCallbackProxy* STATIC_EndTurn(CoreUObject::UObject* WorldContextObject, Engine::APlayerController* PlayerController, const BasicTypes::FString& MatchID, const BasicTypes::TScriptInterface<OnlineSubsystem::ITurnBasedMatchInterface>& TurnBasedMatchInterface);
