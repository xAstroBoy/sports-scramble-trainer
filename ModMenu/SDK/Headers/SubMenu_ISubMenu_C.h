...
{
    /**
     * BlueprintGeneratedClass /Game/Interfaces/SubMenu.SubMenu_C
     * Size -> 0x0000 (FullSize[0x0028] - InheritedSize[0x0028])
     */
    class ISubMenu_C : public CoreUObject::IInterface
    {
    public:
        ...
        static inline CoreUObject::UClass* StaticClass()
        {
            ...
            if (!ptr)
                ptr = CoreUObject::UObject::FindClass("BlueprintGeneratedClass /Game/Interfaces/SubMenu.SubMenu_C");
            return ptr;
        }
    };
}
