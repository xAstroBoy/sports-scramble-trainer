...
{
    /**
     * BlueprintGeneratedClass /Game/Blueprints/Challenges/Tennis/TN_Challenge_07_ProLeague.TN_Challenge_07_ProLeague_C
     * Size -> 0x0036 (FullSize[0x0700] - InheritedSize[0x06CA])
     */
    class ATN_Challenge_07_ProLeague_C : public TN_Challenge_Base::ATN_Challenge_Base_C
    {
    public:
    ...
    public:
        ...
        static inline CoreUObject::UClass* StaticClass()
        {
            ...
            if (!ptr)
                ptr = CoreUObject::UObject::FindClass("BlueprintGeneratedClass /Game/Blueprints/Challenges/Tennis/TN_Challenge_07_ProLeague.TN_Challenge_07_ProLeague_C");
            return ptr;
        }
    };
}
