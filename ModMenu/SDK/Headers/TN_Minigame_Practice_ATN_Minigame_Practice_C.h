...
namespace CG::Launcher_Tennis { class ALauncher_Tennis_C; };
...
{
    /**
     * BlueprintGeneratedClass /Game/Blueprints/Minigames/Tennis/TN_Minigame_Practice.TN_Minigame_Practice_C
     * Size -> 0x00C1 (FullSize[0x03E9] - InheritedSize[0x0328])
     */
    class ATN_Minigame_Practice_C : public Engine::AActor
    {
    public:
        ...
        Launcher_Tennis::ALauncher_Tennis_C*                         LauncherLeftOld;                                         //  Edit, BlueprintVisible, ZeroConstructor, DisableEditOnTemplate, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash
        Launcher_Tennis::ALauncher_Tennis_C*                         LauncherRightOld;                                        //  Edit, BlueprintVisible, ZeroConstructor, DisableEditOnTemplate, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash
        ...
        bool                                                         PracticeServe;                                           //  Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor
    ...
    public:
        ...
        void InpActEvt_Y_K2Node_InputActionEvent_2(const InputCore::FKey& Key);
        ...
        static inline CoreUObject::UClass* StaticClass()
        {
            ...
            if (!ptr)
                ptr = CoreUObject::UObject::FindClass("BlueprintGeneratedClass /Game/Blueprints/Minigames/Tennis/TN_Minigame_Practice.TN_Minigame_Practice_C");
            return ptr;
        }
    };
}
