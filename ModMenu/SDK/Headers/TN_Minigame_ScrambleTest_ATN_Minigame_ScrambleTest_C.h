...
{
    /**
     * BlueprintGeneratedClass /Game/Blueprints/Minigames/Tennis/TN_Minigame_ScrambleTest.TN_Minigame_ScrambleTest_C
     * Size -> 0x00C0 (FullSize[0x03E8] - InheritedSize[0x0328])
     */
    class ATN_Minigame_ScrambleTest_C : public Engine::AActor
    {
    public:
        ...
        bool                                                         RacketTest;                                              //  Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor
        uint8_t                                                      UnknownData_0002[0x7];                                   //  MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
        BasicTypes::TArray<ScramblerTargetSet::FScramblerTargetSet>  RandomBall;                                              //  Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance
    ...
    public:
        ...
        static inline CoreUObject::UClass* StaticClass()
        {
            ...
            if (!ptr)
                ptr = CoreUObject::UObject::FindClass("BlueprintGeneratedClass /Game/Blueprints/Minigames/Tennis/TN_Minigame_ScrambleTest.TN_Minigame_ScrambleTest_C");
            return ptr;
        }
    };
}
