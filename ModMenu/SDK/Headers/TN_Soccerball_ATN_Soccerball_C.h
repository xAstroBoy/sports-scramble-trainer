...
{
    /**
     * BlueprintGeneratedClass /Game/Blueprints/Balls/Tennis/TN_Soccerball.TN_Soccerball_C
     * Size -> 0x000A (FullSize[0x113C] - InheritedSize[0x1132])
     */
    class ATN_Soccerball_C : public TN_Ball_Base::ATN_Ball_Base_C
    {
    public:
    ...
    public:
        ...
        static inline CoreUObject::UClass* StaticClass()
        {
            ...
            if (!ptr)
                ptr = CoreUObject::UObject::FindClass("BlueprintGeneratedClass /Game/Blueprints/Balls/Tennis/TN_Soccerball.TN_Soccerball_C");
            return ptr;
        }
    };
}
