...
{
    /**
     * BlueprintGeneratedClass /Game/Blueprints/Balls/Tennis/TN_Softball.TN_Softball_C
     * Size -> 0x000A (FullSize[0x113C] - InheritedSize[0x1132])
     */
    class ATN_Softball_C : public TN_Ball_Base::ATN_Ball_Base_C
    {
    public:
    ...
    public:
        ...
        static inline CoreUObject::UClass* StaticClass()
        {
            ...
            if (!ptr)
                ptr = CoreUObject::UObject::FindClass("BlueprintGeneratedClass /Game/Blueprints/Balls/Tennis/TN_Softball.TN_Softball_C");
            return ptr;
        }
    };
}
