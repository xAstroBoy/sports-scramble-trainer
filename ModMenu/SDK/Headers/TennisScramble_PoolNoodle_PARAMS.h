...
namespace CG::TennisScramble_PoolNoodle
{
     ...
     * Size -> 0x0000
     */
    class ATennisScramble_PoolNoodle_C_RacquetChanged_Params
    {
    public:
     ...
     * Size -> 0x0000
     */
    class ATennisScramble_PoolNoodle_C_GetRandomInstrument_Params
    {
    public:
     ...
     * Size -> 0x0000
     */
    class ATennisScramble_PoolNoodle_C_ActivateScrambleEffect_Params
    {
    public:
     ...
     * Size -> 0x0000
     */
    class ATennisScramble_PoolNoodle_C_UserConstructionScript_Params
    {
    };
