...
namespace CG::TennisScramble_RaiseNet
{
     ...
     * Size -> 0x0000
     */
    class ATennisScramble_RaiseNet_C_ActivateScrambleEffect_Params
    {
    public:
        ...
        uint8_t                                                      UnknownData_0000[0xF];                                   //  0x0011(0x000F) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY) ()
    };
     ...
     * Size -> 0x0000
     */
    class ATennisScramble_RaiseNet_C_UserConstructionScript_Params
    {
    };
