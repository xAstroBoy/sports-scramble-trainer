...
{
    /**
     * BlueprintGeneratedClass /Game/Blueprints/Scrambles/Tennis/TennisScramble_SoccerBall.TennisScramble_SoccerBall_C
     * Size -> 0x0008 (FullSize[0x0388] - InheritedSize[0x0380])
     */
    class ATennisScramble_SoccerBall_C : public ScrambleEvent_Base::AScrambleEvent_Base_C
    {
    public:
    ...
    public:
        ...
        static inline CoreUObject::UClass* StaticClass()
        {
            ...
            if (!ptr)
                ptr = CoreUObject::UObject::FindClass("BlueprintGeneratedClass /Game/Blueprints/Scrambles/Tennis/TennisScramble_SoccerBall.TennisScramble_SoccerBall_C");
            return ptr;
        }
    };
}
