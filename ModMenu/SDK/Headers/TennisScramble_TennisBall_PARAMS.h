...
namespace CG::TennisScramble_TennisBall
{
     ...
     * Size -> 0x0000
     */
    class ATennisScramble_TennisBall_C_GetNewBallType_Params
    {
    public:
     ...
     * Size -> 0x0000
     */
    class ATennisScramble_TennisBall_C_GetRandomBall_Params
    {
    public:
     ...
     * Size -> 0x0000
     */
    class ATennisScramble_TennisBall_C_ActivateScrambleEffect_Params
    {
    public:
     ...
     * Size -> 0x0000
     */
    class ATennisScramble_TennisBall_C_UserConstructionScript_Params
    {
    };
