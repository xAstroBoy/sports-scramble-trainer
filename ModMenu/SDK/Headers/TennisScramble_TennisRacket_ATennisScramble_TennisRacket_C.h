...
{
    /**
     * BlueprintGeneratedClass /Game/Blueprints/Scrambles/Tennis/TennisScramble_TennisRacket.TennisScramble_TennisRacket_C
     * Size -> 0x0000 (FullSize[0x0380] - InheritedSize[0x0380])
     */
    class ATennisScramble_TennisRacket_C : public ScrambleEvent_Base::AScrambleEvent_Base_C
    {
    public:
        ...
        static inline CoreUObject::UClass* StaticClass()
        {
            ...
            if (!ptr)
                ptr = CoreUObject::UObject::FindClass("BlueprintGeneratedClass /Game/Blueprints/Scrambles/Tennis/TennisScramble_TennisRacket.TennisScramble_TennisRacket_C");
            return ptr;
        }
    };
}
