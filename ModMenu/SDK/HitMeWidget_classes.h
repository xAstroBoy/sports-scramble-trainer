...
// WidgetBlueprintGeneratedClass HitMeWidget.HitMeWidget_C
...
public:
	...
	{
		static auto ptr = UObject::FindClass("WidgetBlueprintGeneratedClass HitMeWidget.HitMeWidget_C");
		return ptr;
	}
	...
	void ExecuteUbergraph_HitMeWidget(int EntryPoint);
};
