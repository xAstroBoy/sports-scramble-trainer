...
// 0x0029 (FullSize[0x0371] - InheritedSize[0x0348])
...
public:
	...
	TEnumAsByte<Engine_ETimelineDirection>             Timeline_Scale__Direction_FB3A0E194A64F31BB64B3B9046E705A1; // 0x0364(0x0001) (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	unsigned char                                      UnknownData_UG9J[0x3];                                     // 0x0365(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass HitMe.HitMe_C");
		return ptr;
	}
	...
	void Grow();
	void Shrink();
	void ExecuteUbergraph_HitMe(int EntryPoint);
};
