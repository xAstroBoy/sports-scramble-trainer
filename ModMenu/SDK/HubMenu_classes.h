...
// 0x0195 (FullSize[0x04BD] - InheritedSize[0x0328])
...
public:
	...
	unsigned char                                      UnknownData_RUZV[0x7];                                     // 0x0411(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	struct FScriptMulticastDelegate                    HubMenuSelection;                                          // 0x0418(0x0010) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, BlueprintAssignable, BlueprintCallable)
	bool                                               Closing;                                                   // 0x0428(0x0001) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor)
	unsigned char                                      UnknownData_2UGH[0x7];                                     // 0x0429(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_OGEH[0x7];                                     // 0x04A1(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	struct FScriptMulticastDelegate                    SelectionStarted;                                          // 0x04A8(0x0010) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, BlueprintAssignable, BlueprintCallable)
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass HubMenu.HubMenu_C");
		return ptr;
	}



	void SpawnBeacons(TEnumAsByte<HubMenuChoices_EHubMenuChoices> SingleBeacon);
	void ResetMenus();
	void CleanUpSelectors(TEnumAsByte<HubMenuChoices_EHubMenuChoices> KeepSelection);
	...
	void SelectionMade(TEnumAsByte<HubMenuChoices_EHubMenuChoices> Selection);
	...
	void SpawnTrophy();
	void SelectionFinished(TEnumAsByte<HubMenuChoices_EHubMenuChoices> Selection);
	void EndNux();
	void ShutDownMenuExternal();
	void PlaySelectionAudio(TEnumAsByte<HubMenuChoices_EHubMenuChoices> Choice);
	void BeaconsRaised();
	void ActivateLookAt();
	...
	void ExecuteUbergraph_HubMenu(int EntryPoint);
	void SelectionStarted__DelegateSignature(TEnumAsByte<HubMenuChoices_EHubMenuChoices> Choice, float Angle);
	void HubMenuSelection__DelegateSignature(TEnumAsByte<HubMenuChoices_EHubMenuChoices> Selection);
};
