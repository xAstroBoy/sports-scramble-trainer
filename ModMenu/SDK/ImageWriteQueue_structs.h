...
struct FImageWriteOptions
{
	...
	unsigned char                                      UnknownData_54NN[0x7];                                     // 0x0001(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_TGH8[0x42];                                    // 0x001E(0x0042) MISSED OFFSET (PADDING)
