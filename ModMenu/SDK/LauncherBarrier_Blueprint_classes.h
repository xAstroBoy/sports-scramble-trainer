...
// 0x004C (FullSize[0x0374] - InheritedSize[0x0328])
...
public:
	...
	TEnumAsByte<Engine_ETimelineDirection>             Timeline_0__Direction_9296466F4D2D83EB64B195B24BE6A454;    // 0x035C(0x0001) (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	unsigned char                                      UnknownData_70E6[0x3];                                     // 0x035D(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass LauncherBarrier_Blueprint.LauncherBarrier_Blueprint_C");
		return ptr;
	}
	...
	void ExecuteUbergraph_LauncherBarrier_Blueprint(int EntryPoint);
};
