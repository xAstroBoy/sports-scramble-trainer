...
namespace CG
{
	 ...
	 * Size -> 0x0129 (FullSize[0x0471] - InheritedSize[0x0348])
	 */
	...
	public:
		...
		unsigned char                                              UnknownData_WS2H[0x2];                                   // 0x039E(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		class FScriptMulticastDelegate                             FinishedReadyMessage;                                    // 0x03A0(0x0010) Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, BlueprintAssignable, BlueprintCallable
		class FText                                                GameEndText;                                             // 0x03B0(0x0018) Edit, BlueprintVisible, DisableEditOnInstance
		...
		class FText                                                TopOrBottomText;                                         // 0x03E0(0x0018) Edit, BlueprintVisible, DisableEditOnInstance
		class FText                                                InningText;                                              // 0x03F8(0x0018) Edit, BlueprintVisible, DisableEditOnInstance
		...
		EGameResult                                                Result;                                                  // 0x0470(0x0001) Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash
