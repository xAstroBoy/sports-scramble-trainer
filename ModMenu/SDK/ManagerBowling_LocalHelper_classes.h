...
public:
	...
	unsigned char                                      UnknownData_7XO7[0x7];                                     // 0x0379(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_UO86[0x7];                                     // 0x03A1(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	struct FName                                       AlternateText_Panel_01;                                    // 0x03A8(0x0008) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	struct FName                                       AlternateText_Panel_02_Prefix;                             // 0x03B0(0x0008) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	struct FName                                       AlternateText_Panel_02_Postfix;                            // 0x03B8(0x0008) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)


	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass ManagerBowling_LocalHelper.ManagerBowling_LocalHelper_C");
		return ptr;
	}
	...
	void DisplayInfo(const struct FText& DisplayText, float DisplayTime);
	void Cleanup();
	void Initialize();
	...
	void DisplayStartOfMatchInfo(int GamesToWin);
	void DisplayNextGame(int PreviousGameWinner, int Game);
	void DisplayMatchOver(TEnumAsByte<GameResult_EGameResult> GameResult);
	void PlayAnnouncerBallChange();
	void PlayAnnouncerVO();
	void ReceiveBeginPlay();
	void PlinkoLaunchSFX(const struct FVector& Location);
	void DisplayAlternateMatchInfo(int GamesTo_Win);
	void DisplayPlayerTurnStart(int Player);
	void DisplayPlayerTurnEnd(int Player);
	void DisplayStartOfTraditionalMatchInfo(int Frames);
	void ExecuteUbergraph_ManagerBowling_LocalHelper(int EntryPoint);
};
