...
// 0x00F0 (FullSize[0x0EC0] - InheritedSize[0x0DD0])
...
public:
	...
	TEnumAsByte<Engine_ETimelineDirection>             Grow__Direction_61819E8F4E07DB4681EC91BBF006FC19;          // 0x0DF4(0x0001) (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	unsigned char                                      UnknownData_ZCLY[0x3];                                     // 0x0DF5(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	TEnumAsByte<Engine_ETimelineDirection>             Shrink__Direction_DEDFDBCC4D6B1597559199BE40D459C2;        // 0x0E04(0x0001) (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	unsigned char                                      UnknownData_4VPI[0x3];                                     // 0x0E05(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_D5JE[0x4];                                     // 0x0E1C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	SportsScramble_EScramInstrumentHitPhysics          OldHitPhysics;                                             // 0x0E49(0x0001) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	unsigned char                                      UnknownData_NEPL[0x2];                                     // 0x0E4A(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass MenuInstrument_BP.MenuInstrument_BP_C");
		return ptr;
	}
	...
	void ExecuteUbergraph_MenuInstrument_BP(int EntryPoint);
};
