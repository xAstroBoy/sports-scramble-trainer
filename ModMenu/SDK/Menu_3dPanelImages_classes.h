...
public:
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass Menu_3dPanelImages.Menu_3dPanelImages_C");
		return ptr;
	}
	...
	void DisableMenu();
	void ExecuteUbergraph_Menu_3dPanelImages(int EntryPoint);
