...
// 0x00EA (FullSize[0x0412] - InheritedSize[0x0328])
...
public:
	...
	TEnumAsByte<GameModeTypes_EGameModeTypes>          Mode;                                                      // 0x03B8(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, ExposeOnSpawn, HasGetValueTypeHash)
	...
	unsigned char                                      UnknownData_XZNK[0x6];                                     // 0x03BA(0x0006) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	TArray<struct FName>                               NameList;                                                  // 0x03C0(0x0010) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance)
	...
	struct FScriptMulticastDelegate                    ChoiceStarted;                                             // 0x03E0(0x0010) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, BlueprintAssignable, BlueprintCallable)
	...
	unsigned char                                      UnknownData_C2ZL[0x3];                                     // 0x03F9(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	int                                                ButtonPresses;                                             // 0x03FC(0x0004) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	struct FScriptMulticastDelegate                    SelectionComplete;                                         // 0x0400(0x0010) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, BlueprintAssignable, BlueprintCallable)
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass Menu_IndexSelection.Menu_IndexSelection_C");
		return ptr;
	}
	...
	void ShouldButtonBeLocked(int Index, TEnumAsByte<UI_ButtonState_EUI_ButtonState>* ButtonState, bool* ShowTrophy);
	void SpawnButtons();
	void Initialize();
	...
	void ExecuteUbergraph_Menu_IndexSelection(int EntryPoint);
	void SelectionComplete__DelegateSignature(int ID, const struct FName& GameName);
	void ChoiceStarted__DelegateSignature(int ID);
};
