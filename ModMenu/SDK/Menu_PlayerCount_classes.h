...
public:
	...
	TEnumAsByte<Engine_ETimelineDirection>             Timeline_Scale4__Direction_621DB665422DCA37A1247C964B8D2B8A; // 0x038C(0x0001) (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	unsigned char                                      UnknownData_Y809[0x3];                                     // 0x038D(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	TEnumAsByte<Engine_ETimelineDirection>             Timeline_Scale3__Direction_36FF9F764D710A5A0EAA859D8F33D652; // 0x039C(0x0001) (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	unsigned char                                      UnknownData_3UB5[0x3];                                     // 0x039D(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass Menu_PlayerCount.Menu_PlayerCount_C");
		return ptr;
	}
	...
	void UpdateDisplay(int PlayerCount);
	void Initialize();
	...
	void Hide3();
	void Hide4();
	void ExecuteUbergraph_Menu_PlayerCount(int EntryPoint);
};
