...
// WidgetBlueprintGeneratedClass MessageProgressWidget.MessageProgressWidget_C
...
public:
	...
	{
		static auto ptr = UObject::FindClass("WidgetBlueprintGeneratedClass MessageProgressWidget.MessageProgressWidget_C");
		return ptr;
	}
