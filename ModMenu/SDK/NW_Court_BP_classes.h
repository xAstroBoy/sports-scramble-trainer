...
public:
	...
	TEnumAsByte<Engine_ETimelineDirection>             Court_Lines__Direction_3A1A8714410263DB0EC1D7910E1198AB;   // 0x03CC(0x0001) (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	unsigned char                                      UnknownData_FDKS[0x3];                                     // 0x03CD(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	class UTimelineComponent*                          Court_Lines;                                               // 0x03D0(0x0008) (BlueprintVisible, ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	class UMaterialInstanceDynamic*                    Line_Ring_Reveal_Size;                                     // 0x03D8(0x0008) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	class UMaterialInstanceDynamic*                    Court_Reveal;                                              // 0x03E0(0x0008) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	struct FScriptMulticastDelegate                    CourtRevealComplete;                                       // 0x03E8(0x0010) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, BlueprintAssignable, BlueprintCallable)
	struct FScriptMulticastDelegate                    CourtHideComplete;                                         // 0x03F8(0x0010) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, BlueprintAssignable, BlueprintCallable)
	bool                                               CourtSpawnRevealed;                                        // 0x0408(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, ExposeOnSpawn)
	unsigned char                                      UnknownData_JPLO[0x3];                                     // 0x0409(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	float                                              Play_Rate;                                                 // 0x040C(0x0004) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass NW_Court_BP.NW_Court_BP_C");
		return ptr;
	}
	...
	void Court_Lines__FinishedFunc();
	void Court_Lines__UpdateFunc();
	void Court_Lines__SFX_Event_ForeSwipe__EventFunc();
	void Court_Lines__SFX_Event_SideSwipes__EventFunc();
	void Court_Lines__SFX_Event_MidSwipe__EventFunc();
	void Court_Lines__SFX_Event_BigSwipe__EventFunc();
	...
	void ExecuteUbergraph_NW_Court_BP(int EntryPoint);
