...
{
	unsigned char                                      UnknownData_XFDI[0xB8];                                    // 0x0000(0x00B8) MISSED OFFSET (PADDING)
...
struct FPlayerReservation
{
	...
	unsigned char                                      UnknownData_B5JW[0x3];                                     // 0x0049(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FPartyReservation
{
	...
	unsigned char                                      UnknownData_30F5[0x4];                                     // 0x0004(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
