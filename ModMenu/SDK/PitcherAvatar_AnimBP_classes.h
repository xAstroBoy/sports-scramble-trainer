...
// 0x1730 (FullSize[0x1B80] - InheritedSize[0x0450])
...
public:
	...
	class UAnimSequenceBase*                           Right_Mitt_Catch;                                          // 0x1B78(0x0008) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)


	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass("AnimBlueprintGeneratedClass PitcherAvatar_AnimBP.PitcherAvatar_AnimBP_C");
		return ptr;
	}
	...
	void ExecuteUbergraph_PitcherAvatar_AnimBP(int EntryPoint);
};
