...
{
public:
	unsigned char                                      UnknownData_UKI6[0x8];                                     // 0x0238(0x0008) Fix Super Size
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass PlatformMaterialSwapComp.PlatformMaterialSwapComp_C");
		return ptr;
	}
	...
	void ExecuteUbergraph_PlatformMaterialSwapComp(int EntryPoint);
};
