...
public:
	...
	TEnumAsByte<Engine_ETimelineDirection>             Timeline_ScaleDown__Direction_9DA68F444A43E211F08E328891C8BCAB; // 0x037C(0x0001) (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	unsigned char                                      UnknownData_YSET[0x3];                                     // 0x037D(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_CAMY[0x6];                                     // 0x0392(0x0006) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass SS_Logo.SS_Logo_C");
		return ptr;
	}
	...
	void ScaleUp();
	void ExecuteUbergraph_SS_Logo(int EntryPoint);
};
