...
// 0x011A (FullSize[0x0ACA] - InheritedSize[0x09B0])
...
public:
	...
	TEnumAsByte<Engine_ETimelineDirection>             Timeline_Fade__Direction_224CBD364A8D6ECA75A271AA329BF531; // 0x09BC(0x0001) (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	unsigned char                                      UnknownData_05KO[0x3];                                     // 0x09BD(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	int                                                Buttons;                                                   // 0x09C8(0x0004) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	unsigned char                                      UnknownData_XLLX[0x4];                                     // 0x09CC(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_3LOK[0x3];                                     // 0x0A01(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	struct FScriptMulticastDelegate                    PlayerFadedOut;                                            // 0x0A10(0x0010) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, BlueprintAssignable, BlueprintCallable)
	...
	unsigned char                                      UnknownData_65XR[0x5];                                     // 0x0A23(0x0005) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	struct FScriptMulticastDelegate                    PlayerExitBoundary;                                        // 0x0A30(0x0010) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, BlueprintAssignable, BlueprintCallable)
	struct FScriptMulticastDelegate                    PlayerEnterBoundary;                                       // 0x0A40(0x0010) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, BlueprintAssignable, BlueprintCallable)
	struct FString                                     VoicePermissionString;                                     // 0x0A50(0x0010) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, HasGetValueTypeHash)
	bool                                               SlomoMode;                                                 // 0x0A60(0x0001) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor)
	unsigned char                                      UnknownData_B5YN[0x7];                                     // 0x0A61(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	int                                                SlomoFastIndex;                                            // 0x0A88(0x0004) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	int                                                SlomoSlowIndex;                                            // 0x0A8C(0x0004) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                               SlomoReset;                                                // 0x0A90(0x0001) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor)
	unsigned char                                      UnknownData_614Z[0x7];                                     // 0x0A91(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	struct FScriptMulticastDelegate                    RemotePlayerReady;                                         // 0x0AA0(0x0010) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, BlueprintAssignable, BlueprintCallable)
	struct FScriptMulticastDelegate                    PlayerRecentered;                                          // 0x0AB0(0x0010) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, BlueprintAssignable, BlueprintCallable)
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass ScramPlayer_BP.ScramPlayer_BP_C");
		return ptr;
	}
	...
	void Cleanup();
	void SlomoDecrement(int* Index, TArray<float> Array);
	void SlomoIncrement(int* Index, TArray<float> Array);
	...
	void ExecuteUbergraph_ScramPlayer_BP(int EntryPoint);
	void PlayerRecentered__DelegateSignature();
	void RemotePlayerReady__DelegateSignature(int ID);
