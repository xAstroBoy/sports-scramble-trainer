...
// 0x045A (FullSize[0x0B1A] - InheritedSize[0x06C0])
...
public:
	...
	TEnumAsByte<Engine_ETimelineDirection>             Timeline_OrganFade__Direction_F2AE027C4A618FA4D20BE980962382FF; // 0x078C(0x0001) (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	unsigned char                                      UnknownData_Y87P[0x3];                                     // 0x078D(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	int                                                MaxOuts;                                                   // 0x07C0(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	int                                                Outs;                                                      // 0x07C4(0x0004) (Edit, BlueprintVisible, Net, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	unsigned char                                      UnknownData_SY5O[0x8];                                     // 0x07C8(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	int                                                VisitorsTotalScore;                                        // 0x0818(0x0004) (Edit, BlueprintVisible, Net, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	int                                                HomeTotalScore;                                            // 0x081C(0x0004) (Edit, BlueprintVisible, Net, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	int                                                CurrentInning;                                             // 0x0820(0x0004) (Edit, BlueprintVisible, Net, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	int                                                MaxInnings;                                                // 0x0824(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	int                                                PointsForSingle;                                           // 0x0828(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	int                                                PointsForDouble;                                           // 0x082C(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	int                                                PointsForTriple;                                           // 0x0830(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	int                                                PointsForHomeRun;                                          // 0x0834(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	unsigned char                                      UnknownData_XAKP[0x3];                                     // 0x0839(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	int                                                PitcherPointsStrike;                                       // 0x083C(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	unsigned char                                      UnknownData_IXG4[0x3];                                     // 0x0875(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_GD3S[0x4];                                     // 0x088C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_CWT4[0x2];                                     // 0x089A(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_QBD9[0x6];                                     // 0x094A(0x0006) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	int                                                PitchTargetScoreAmount;                                    // 0x0958(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	unsigned char                                      UnknownData_CJH8[0x4];                                     // 0x095C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	int                                                OutfieldTargetScoreAmt;                                    // 0x0968(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	unsigned char                                      UnknownData_9Z6Q[0x3];                                     // 0x096D(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_OWTU[0x4];                                     // 0x0984(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_ETE3[0x6];                                     // 0x0992(0x0006) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_5KUA[0x7];                                     // 0x09B1(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	struct FScriptMulticastDelegate                    OnSidesSwitchedDispatcher;                                 // 0x09B8(0x0010) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, BlueprintAssignable, BlueprintCallable)
	...
	class ABallSelector_Listener_C*                    Ball_Selector_Listener;                                    // 0x0A40(0x0008) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnTemplate, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	int                                                Strikes;                                                   // 0x0A50(0x0004) (Edit, BlueprintVisible, Net, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	int                                                StrikeoutCount;                                            // 0x0A54(0x0004) (Edit, BlueprintVisible, Net, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	unsigned char                                      UnknownData_KU5I[0x7];                                     // 0x0A59(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	struct FScriptMulticastDelegate                    GameCompleted;                                             // 0x0A68(0x0010) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, BlueprintAssignable, BlueprintCallable)
	...
	unsigned char                                      UnknownData_V5MO[0x7];                                     // 0x0A99(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_3LPT[0x7];                                     // 0x0AC9(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_1ZQU[0x1];                                     // 0x0AE3(0x0001) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_UIOS[0x7];                                     // 0x0B01(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	bool                                               HomeRun_;                                                  // 0x0B19(0x0001) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor)


	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass ScramSportManagerBaseball_Blueprint.ScramSportManagerBaseball_Blueprint_C");
		return ptr;
	}



	void GetRandomInstrument(SportsScramble_EBaseballInstrumentType ExcludeType, struct FBaseballInstrumentEntryProperties* NewInstrument, bool* Successful);
	...
	void GetFielderDifficulty(SportsScramble_EDifficulty* NewParam);
	void SpawnFielder(SportsScramble_EDifficulty Difficulty, class USceneComponent* Position, bool IsOutfielder, const struct FMinMaxAngle& OutfieldMovementRange);
	...
	void UpdateOutsAndFreebies(int Outs, int Freebies, int Strikes);
	...
	void RegisterStrike();
	void RegisterOut(int NewOuts, bool PlayUmpireOut, bool PlayOrgan);
	void HandleGameEnd();
	...
	void BeginGame();
	void PitchTargetHit(int ScoreAmount);
	void BatterHitOutfieldTarget(class AScramBall* Ball, int TargetId);
	void SendRestartGame();
	void UpdateGameScore(int NewP1TotalScore, int NewP2TotalScore);
	void SwitchSides(bool TopOfTheInning, int CurrentInning);
	void Single();
	void Double();
	void Triple();
	...
	void NetUpdateOutsAndFreebies(int Outs, int Freebies, int Strikes);
	void ResetCount();
	void PitchingTargetsUpdated(bool TL, bool TR, bool BL, bool BR);
	void PitchingTargetHit(SportsScramble_EBaseballScrambleTargetLocations Location);
	...
	void Multi_SetInning(int Inning, bool Top);
	void OnGameDone();
	...
	void ExecuteUbergraph_ScramSportManagerBaseball_Blueprint(int EntryPoint);
	void GameCompleted__DelegateSignature(bool LocalPlayerVictory, int AwayScore, int HomeScore);
