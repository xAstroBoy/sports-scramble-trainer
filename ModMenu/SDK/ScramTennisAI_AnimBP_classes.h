...
namespace CG
{
	...
	public:
		...
		class FScriptMulticastDelegate                             PlaySwingFX;                                             // 0x18A8(0x0010) Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, BlueprintAssignable, BlueprintCallable
