...
// 0x0081 (FullSize[0x07C1] - InheritedSize[0x0740])
...
public:
	...
	TEnumAsByte<Engine_ETimelineDirection>             Timeline_ScaleUp__Direction_EB297C5345142E015D0AF8A0F40524AA; // 0x076C(0x0001) (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	unsigned char                                      UnknownData_2554[0x3];                                     // 0x076D(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_4M83[0x7];                                     // 0x07A9(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	struct FScriptMulticastDelegate                    AI_Hit_Ball;                                               // 0x07B0(0x0010) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, BlueprintAssignable, BlueprintCallable)
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass ScramTennisAI_Blueprint.ScramTennisAI_Blueprint_C");
		return ptr;
	}
	...
	void PlaySwingFX();
	void ScaleUp();
	void ExecuteUbergraph_ScramTennisAI_Blueprint(int EntryPoint);
