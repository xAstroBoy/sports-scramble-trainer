...
public:
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass ScrambleEvent_Base.ScrambleEvent_Base_C");
		return ptr;
	}
	...
	void QueueScrambleEffect(const struct FScriptDelegate& BallHitDelegate, const struct FScriptDelegate& OnDestroyedDelegate);
	...
	void CheckEquipmentMatch(class ATN_Ball_Base_C* Ball, bool CheckInstrument, class ATN_Instrument_Base_C* Instrument, bool LocalPlayerInstrument_);
	void ExecuteUbergraph_ScrambleEvent_Base(int EntryPoint);
};
