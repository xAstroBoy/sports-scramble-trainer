...
public:
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass SkeeBallLane.SkeeBallLane_C");
		return ptr;
	}
	...
	void UpdateGoodHoleCount(int NewGoodHoleCount, bool* HoleCountUpdated);
