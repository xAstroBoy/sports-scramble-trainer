...
// 0x0248 (FullSize[0x1158] - InheritedSize[0x0F10])
...
public:
	...
	unsigned char                                      UnknownData_96QO[0x5];                                     // 0x0F2B(0x0005) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_ZWLN[0x4];                                     // 0x0F44(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_BEVE[0x4];                                     // 0x0F74(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_0RCO[0x4];                                     // 0x0F9C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_FTJ5[0x4];                                     // 0x0FCC(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_7CUQ[0x4];                                     // 0x0FEC(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_OGAY[0x4];                                     // 0x1014(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_KID4[0x4];                                     // 0x104C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	TMap<SportsScramble_ETennisShotType, class UClass*> TrailMap;                                                  // 0x1050(0x0050) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance)
	TMap<SportsScramble_ETennisShotType, float>        TrailScaleMap;                                             // 0x10A0(0x0050) (Edit, BlueprintVisible, ZeroConstructor)
	...
	unsigned char                                      UnknownData_LML3[0x4];                                     // 0x10F4(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	struct FScriptMulticastDelegate                    BallShotTypeChange;                                        // 0x1120(0x0010) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, BlueprintAssignable, BlueprintCallable)
	...
	TEnumAsByte<CrossPlayType_ECrossPlayType>          CrossPlayRestriction;                                      // 0x1141(0x0001) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	unsigned char                                      UnknownData_OG4H[0x6];                                     // 0x1142(0x0006) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass TN_Ball_Base.TN_Ball_Base_C");
		return ptr;
	}
	...
	void Ball_Hit(class UObject* WorldContextObject, class UScramEventBasePayload* Payload);
	...
	void ExecuteUbergraph_TN_Ball_Base(int EntryPoint);
	void BallShotTypeChange__DelegateSignature(SportsScramble_ETennisShotType ShotType);
};
