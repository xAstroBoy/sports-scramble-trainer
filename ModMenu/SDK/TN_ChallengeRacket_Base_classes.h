...
namespace CG
{
	...
	public:
		...
		unsigned char                                              UnknownData_LZ22[0x3];                                   // 0x0FC5(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_XSYM[0x3];                                   // 0x1029(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
