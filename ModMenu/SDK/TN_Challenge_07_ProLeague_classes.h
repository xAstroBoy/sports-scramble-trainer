...
// BlueprintGeneratedClass TN_Challenge_07_ProLeague.TN_Challenge_07_ProLeague_C
// 0x0036 (FullSize[0x06F0] - InheritedSize[0x06BA])
class ATN_Challenge_07_ProLeague_C : public ATN_Challenge_Base_C
{
public:
	unsigned char                                      UnknownData_R9G1[0x6];                                     // 0x06BA(0x0006) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass TN_Challenge_07_ProLeague.TN_Challenge_07_ProLeague_C");
		return ptr;
	}
	...
	void Shortcut();
	void ExecuteUbergraph_TN_Challenge_07_ProLeague(int EntryPoint);
};
