...
namespace CG
{
	...
	{
	public:
		unsigned char                                              UnknownData_PKXT[0x6];                                   // 0x06BA(0x0006) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	public:
		...
		void Shortcut();
		void ExecuteUbergraph_TN_Challenge_07_ProLeague(int32_t EntryPoint);
