...
// 0x0229 (FullSize[0x06BA] - InheritedSize[0x0491])
class ATN_Challenge_Base_C : public AChallengeBase_C
{
public:
	unsigned char                                      UnknownData_YQ7J[0x7];                                     // 0x0491(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_AXO9[0x7];                                     // 0x0539(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	int                                                Bounces;                                                   // 0x0570(0x0004) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	unsigned char                                      UnknownData_W7Y2[0x4];                                     // 0x0574(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_WJVP[0x7];                                     // 0x0591(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_85F2[0x7];                                     // 0x05D9(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	int                                                Streak;                                                    // 0x0610(0x0004) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	int                                                TargetHitReward;                                           // 0x0614(0x0004) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	int                                                BullseyeHitReward;                                         // 0x0618(0x0004) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	int                                                MiddleHitReward;                                           // 0x061C(0x0004) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	unsigned char                                      UnknownData_J2HK[0x7];                                     // 0x0639(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	TEnumAsByte<GameResult_EGameResult>                ChallengeResult;                                           // 0x06B9(0x0001) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)


	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass TN_Challenge_Base.TN_Challenge_Base_C");
		return ptr;
	}
	...
	void TN_CHG_UpdateArenaScoreboards(int Player1Score, int Player2Score, int Player1Games, int Player2Games, bool Player1Serve, bool Player2Serve, bool UpdateScoreOnly);
	...
	void TN_CHG_CalculateEndTennisMatch(TEnumAsByte<GameResult_EGameResult> Result);
	void TN_CHG_SpawnFloorLightUpGroup(bool Player2, bool OutOnly, bool InOnly, bool Demo);
	void TN_CHG_SpawnSportManager(bool UseScrambler, bool UseStartOfMatchInfoPanels, const struct FName& ScrambleSchedule);
	void TN_CHG_SpawnAIOpponent(class UClass* AIActorClass, class AScramTennisAI** ScramTennisAI);
	void TN_CHG_SpawnReturnWallAndLauncher(TEnumAsByte<TN_ReturnWall_ScoreType_ETN_ReturnWall_ScoreType> ReurnWallType);
	...
	void TN_CHG_CalculateEndScore(bool Countdown, int CurrentScore, int TargetScore);
	...
	void TN_CHG_WallTargetHit(class AActor* PayloadActor, class AActor* BallTargetActor, int RegionHit);
	...
	void TN_CHG_TimerTriggered(int CurrentTime);
	...
	void PlayAsync2D();
	void ExecuteUbergraph_TN_Challenge_Base(int EntryPoint);
};
