...
// BlueprintGeneratedClass TN_Chicken.TN_Chicken_C
...
public:
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass TN_Chicken.TN_Chicken_C");
		return ptr;
	}
	...
	void ExecuteUbergraph_TN_Chicken(int EntryPoint);
};
