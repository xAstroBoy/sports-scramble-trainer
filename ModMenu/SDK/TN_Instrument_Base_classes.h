...
// 0x0128 (FullSize[0x0FB8] - InheritedSize[0x0E90])
...
public:
	...
	TEnumAsByte<Engine_ETimelineDirection>             Timeline_Emissive__Direction_5D9A1EFE49C3E85973EAE3A186FC7413; // 0x0EB4(0x0001) (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	unsigned char                                      UnknownData_2MDW[0x3];                                     // 0x0EB5(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	TEnumAsByte<Engine_ETimelineDirection>             Grow__Direction_02DB3B08431413463BEFE6A1532DF421;          // 0x0EC4(0x0001) (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	unsigned char                                      UnknownData_TN0N[0x3];                                     // 0x0EC5(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	TEnumAsByte<Engine_ETimelineDirection>             Shrink__Direction_00D980264E5F46E73667E1A03F355299;        // 0x0ED4(0x0001) (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	unsigned char                                      UnknownData_Z7CB[0x3];                                     // 0x0ED5(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_U0F2[0x4];                                     // 0x0EEC(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	SportsScramble_EScramInstrumentHitPhysics          OldHitPhysics;                                             // 0x0F19(0x0001) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	unsigned char                                      UnknownData_CHXB[0x2];                                     // 0x0F1A(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	int                                                EmmisiveSlot;                                              // 0x0F28(0x0004) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	unsigned char                                      UnknownData_K4TE[0x3];                                     // 0x0F2D(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	SportsScramble_ETennisShotType                     ShotType;                                                  // 0x0F94(0x0001) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	unsigned char                                      UnknownData_7R68[0x3];                                     // 0x0F95(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	TEnumAsByte<CrossPlayType_ECrossPlayType>          CrossPlayRestriction;                                      // 0x0FA0(0x0001) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	unsigned char                                      UnknownData_QPXK[0x3];                                     // 0x0FA1(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass TN_Instrument_Base.TN_Instrument_Base_C");
		return ptr;
	}
	...
	void UpdateMesh();
	void InitializeColors_Material();
	...
	void ExecuteUbergraph_TN_Instrument_Base(int EntryPoint);
};
