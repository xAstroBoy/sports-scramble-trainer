...
// 0x0118 (FullSize[0x0460] - InheritedSize[0x0348])
...
public:
	...
	TEnumAsByte<Engine_ETimelineDirection>             Rise__Direction_8AC176794C24A2FB24F8ACB8CAA97BA4;          // 0x03B4(0x0001) (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	unsigned char                                      UnknownData_Z5VE[0x3];                                     // 0x03B5(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_V8X1[0x3];                                     // 0x03C5(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_7FH3[0x7];                                     // 0x03E1(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_01QE[0x7];                                     // 0x0419(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass TN_TRN_CHG_TargetWall.TN_TRN_CHG_TargetWall_C");
		return ptr;
	}
	...
	void ExecuteUbergraph_TN_TRN_CHG_TargetWall(int EntryPoint);
};
