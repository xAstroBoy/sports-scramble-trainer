...
// 0x00F4 (FullSize[0x0686] - InheritedSize[0x0592])
class ATN_Train_01_BasicHitting_C : public ATN_Train_Base_C
{
public:
	unsigned char                                      UnknownData_A9NP[0x6];                                     // 0x0592(0x0006) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	int                                                maxBalls;                                                  // 0x05D8(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	TArray<struct FName>                               LivingRoom_RightHanded_2;                                  // 0x05E0(0x0010) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance)
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass TN_Train_01_BasicHitting.TN_Train_01_BasicHitting_C");
		return ptr;
	}
	...
	void CustomEvent_6();
	void CustomEvent_7();
	void ExecuteUbergraph_TN_Train_01_BasicHitting(int EntryPoint);
};
