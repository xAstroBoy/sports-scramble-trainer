...
// 0x00D0 (FullSize[0x0662] - InheritedSize[0x0592])
class ATN_Train_06_ScrambleInstruments_C : public ATN_Train_Base_C
{
public:
	unsigned char                                      UnknownData_XSTF[0x6];                                     // 0x0592(0x0006) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_LW7F[0x4];                                     // 0x05B4(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass TN_Train_06_ScrambleInstruments.TN_Train_06_ScrambleInstruments_C");
		return ptr;
	}
	...
	void CustomEvent_7();
	void CustomEvent_8();
	void ExecuteUbergraph_TN_Train_06_ScrambleInstruments(int EntryPoint);
};
