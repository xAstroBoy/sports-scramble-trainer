...
public:
	...
	TEnumAsByte<Engine_ETimelineDirection>             Timeline_Cover2__Direction_0FB27A7A4B2C921A2C7A1A8B4B1EE516; // 0x036C(0x0001) (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	unsigned char                                      UnknownData_IQ7T[0x3];                                     // 0x036D(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	TEnumAsByte<Engine_ETimelineDirection>             Timeline_Cover1__Direction_E2B441B0427A658A2EBD19A8CDC64408; // 0x037C(0x0001) (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	unsigned char                                      UnknownData_CNSI[0x3];                                     // 0x037D(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_VUW4[0x6];                                     // 0x0392(0x0006) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	struct FText                                       AdText;                                                    // 0x0398(0x0018) (Edit, BlueprintVisible, DisableEditOnInstance)
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass TennisArenaScoreboard.TennisArenaScoreboard_C");
		return ptr;
	}
	...
	void UpdateScore(int Player1Score, int Player2Score, int Player1Games, int Player2Games, bool Player1Serve, bool Player2Serve, bool UpdateScoreOnly);
	void Initialize();
	...
	void ExecuteUbergraph_TennisArenaScoreboard(int EntryPoint);
};
