...
public:
	...
	TEnumAsByte<Engine_ETimelineDirection>             Timeline_HideNet__Direction_E72227334CB2B2DE6A08DDBC9107E3B0; // 0x038C(0x0001) (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	unsigned char                                      UnknownData_ZX2S[0x3];                                     // 0x038D(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_ZV2H[0x3];                                     // 0x0399(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass TennisNet_BP.TennisNet_BP_C");
		return ptr;
	}
	...
	void HideNet();
	void ShowNet();
	void PlayNetMoveSFX_();
	void ExecuteUbergraph_TennisNet_BP(int EntryPoint);
};
