...
namespace CG
{
	...
	public:
		...
		ETimelineDirection                                         GrowShrinkIcon__Direction_B064D7D142DF0DF0BEBDD4A055A4AB8E; // 0x0474(0x0001) ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash
		unsigned char                                              UnknownData_ITX7[0x3];                                   // 0x0475(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		int32_t                                                    ID;                                                      // 0x0498(0x0004) Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, ExposeOnSpawn, HasGetValueTypeHash
