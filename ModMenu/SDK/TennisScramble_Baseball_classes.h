...
// BlueprintGeneratedClass TennisScramble_Baseball.TennisScramble_Baseball_C
...
public:
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass TennisScramble_Baseball.TennisScramble_Baseball_C");
		return ptr;
	}
