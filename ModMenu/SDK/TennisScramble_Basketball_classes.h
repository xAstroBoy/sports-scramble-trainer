...
// BlueprintGeneratedClass TennisScramble_Basketball.TennisScramble_Basketball_C
...
public:
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass TennisScramble_Basketball.TennisScramble_Basketball_C");
		return ptr;
	}
