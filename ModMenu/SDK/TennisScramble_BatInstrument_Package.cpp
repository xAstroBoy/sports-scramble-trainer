...
namespace CG
{
	 ...
	 * Function:
	 * 		RVA    -> 0x00669880
	 * 		Name   -> Function TennisScramble_BatInstrument.TennisScramble_BatInstrument_C.RacquetChanged
	...
	void ATennisScramble_BatInstrument_C::RacquetChanged(class AActor* Player, class ATN_Instrument_Base_C* Instrument)
	{
		...
		if (!fn)
			fn = UObject::FindObject<UFunction>("Function TennisScramble_BatInstrument.TennisScramble_BatInstrument_C.RacquetChanged");
	 ...
	 * Function:
	 * 		RVA    -> 0x00669880
	 * 		Name   -> Function TennisScramble_BatInstrument.TennisScramble_BatInstrument_C.GetRandomInstrument
	...
	void ATennisScramble_BatInstrument_C::GetRandomInstrument(class UClass* InstrumentClass, class UClass** NewInstrument)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>("Function TennisScramble_BatInstrument.TennisScramble_BatInstrument_C.GetRandomInstrument");
	 ...
	 * Function:
	 * 		RVA    -> 0x00669880
	 * 		Name   -> Function TennisScramble_BatInstrument.TennisScramble_BatInstrument_C.ActivateScrambleEffect
	 * 		Flags  -> (Public, HasOutParms, BlueprintCallable, BlueprintEvent)
	 * Parameters:
	...
	void ATennisScramble_BatInstrument_C::ActivateScrambleEffect(class ATN_Ball_Base_C* Ball, class AActor* OtherActor, bool* ScrambleEffectSuccess)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>("Function TennisScramble_BatInstrument.TennisScramble_BatInstrument_C.ActivateScrambleEffect");
	 ...
	 * Function:
	 * 		RVA    -> 0x00669880
	 * 		Name   -> Function TennisScramble_BatInstrument.TennisScramble_BatInstrument_C.UserConstructionScript
	...
	void ATennisScramble_BatInstrument_C::UserConstructionScript()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>("Function TennisScramble_BatInstrument.TennisScramble_BatInstrument_C.UserConstructionScript");
	 ...
	 * Function:
	 * 		RVA    -> 0x00000000
	 * 		Name   -> PredefinedFunction ATennisScramble_BatInstrument_C.StaticClass
	 * 		Flags  -> (Predefined, Static)
	 */
	UClass* ATennisScramble_BatInstrument_C::StaticClass()
	{
		static UClass* ptr = nullptr;
		if (!ptr)
			ptr = UObject::FindClass("BlueprintGeneratedClass TennisScramble_BatInstrument.TennisScramble_BatInstrument_C");
		return ptr;
	}
