...
// BlueprintGeneratedClass TennisScramble_BeachBall.TennisScramble_BeachBall_C
...
public:
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass TennisScramble_BeachBall.TennisScramble_BeachBall_C");
		return ptr;
	}
