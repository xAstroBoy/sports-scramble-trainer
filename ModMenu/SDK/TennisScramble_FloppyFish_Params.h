...
namespace CG
{
	 ...
	 */
	struct ATennisScramble_FloppyFish_C_RacquetChanged_Params
	{
	public:
	 ...
	 */
	struct ATennisScramble_FloppyFish_C_GetRandomInstrument_Params
	{
	public:
	 ...
	 */
	struct ATennisScramble_FloppyFish_C_ActivateScrambleEffect_Params
	{
	public:
		...
		unsigned char                                              UnknownData_NKPH[0x7];                                   // 0x0011(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY) ()
	};

	/**
	 * Function TennisScramble_FloppyFish.TennisScramble_FloppyFish_C.UserConstructionScript
	 */
	struct ATennisScramble_FloppyFish_C_UserConstructionScript_Params
	{	};
