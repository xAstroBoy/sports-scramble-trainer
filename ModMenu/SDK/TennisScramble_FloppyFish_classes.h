...
// BlueprintGeneratedClass TennisScramble_FloppyFish.TennisScramble_FloppyFish_C
...
public:
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass TennisScramble_FloppyFish.TennisScramble_FloppyFish_C");
		return ptr;
	}
