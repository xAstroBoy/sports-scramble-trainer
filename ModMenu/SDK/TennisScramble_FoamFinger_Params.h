...
namespace CG
{
	 ...
	 */
	struct ATennisScramble_FoamFinger_C_RacquetChanged_Params
	{
	public:
	 ...
	 */
	struct ATennisScramble_FoamFinger_C_GetRandomInstrument_Params
	{
	public:
	 ...
	 */
	struct ATennisScramble_FoamFinger_C_ActivateScrambleEffect_Params
	{
	public:
		...
		unsigned char                                              UnknownData_7B5L[0x7];                                   // 0x0011(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY) ()
	};

	/**
	 * Function TennisScramble_FoamFinger.TennisScramble_FoamFinger_C.UserConstructionScript
	 */
	struct ATennisScramble_FoamFinger_C_UserConstructionScript_Params
	{	};
