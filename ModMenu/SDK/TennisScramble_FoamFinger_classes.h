...
// BlueprintGeneratedClass TennisScramble_FoamFinger.TennisScramble_FoamFinger_C
...
public:
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass TennisScramble_FoamFinger.TennisScramble_FoamFinger_C");
		return ptr;
	}
