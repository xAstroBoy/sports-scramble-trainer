...
namespace CG
{
	 ...
	 */
	struct ATennisScramble_GolfClub_C_RacquetChanged_Params
	{
	public:
	 ...
	 */
	struct ATennisScramble_GolfClub_C_GetRandomInstrument_Params
	{
	public:
	 ...
	 */
	struct ATennisScramble_GolfClub_C_ActivateScrambleEffect_Params
	{
	public:
		...
		unsigned char                                              UnknownData_ZHS3[0x7];                                   // 0x0011(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY) ()
	};

	/**
	 * Function TennisScramble_GolfClub.TennisScramble_GolfClub_C.UserConstructionScript
	 */
	struct ATennisScramble_GolfClub_C_UserConstructionScript_Params
	{	};
