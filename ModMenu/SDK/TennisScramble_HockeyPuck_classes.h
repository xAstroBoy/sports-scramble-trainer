...
// BlueprintGeneratedClass TennisScramble_HockeyPuck.TennisScramble_HockeyPuck_C
...
public:
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass TennisScramble_HockeyPuck.TennisScramble_HockeyPuck_C");
		return ptr;
	}
