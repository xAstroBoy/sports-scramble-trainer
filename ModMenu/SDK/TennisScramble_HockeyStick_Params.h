...
namespace CG
{
	 ...
	 */
	struct ATennisScramble_HockeyStick_C_RacquetChanged_Params
	{
	public:
	 ...
	 */
	struct ATennisScramble_HockeyStick_C_GetRandomInstrument_Params
	{
	public:
	 ...
	 */
	struct ATennisScramble_HockeyStick_C_ActivateScrambleEffect_Params
	{
	public:
		...
		unsigned char                                              UnknownData_YZ2Z[0x7];                                   // 0x0011(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY) ()
	};

	/**
	 * Function TennisScramble_HockeyStick.TennisScramble_HockeyStick_C.UserConstructionScript
	 */
	struct ATennisScramble_HockeyStick_C_UserConstructionScript_Params
	{	};
