...
// BlueprintGeneratedClass TennisScramble_PingPongBall.TennisScramble_PingPongBall_C
...
public:
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass TennisScramble_PingPongBall.TennisScramble_PingPongBall_C");
		return ptr;
	}
