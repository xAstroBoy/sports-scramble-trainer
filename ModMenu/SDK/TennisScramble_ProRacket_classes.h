...
// BlueprintGeneratedClass TennisScramble_ProRacket.TennisScramble_ProRacket_C
...
public:
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass TennisScramble_ProRacket.TennisScramble_ProRacket_C");
		return ptr;
	}
