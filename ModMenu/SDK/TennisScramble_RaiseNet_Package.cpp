...
namespace CG
{
	 ...
	 * Function:
	 * 		RVA    -> 0x00669880
	 * 		Name   -> Function TennisScramble_RaiseNet.TennisScramble_RaiseNet_C.ActivateScrambleEffect
	...
	void ATennisScramble_RaiseNet_C::ActivateScrambleEffect(class ATN_Ball_Base_C* Ball, class AActor* OtherActor, bool* ScrambleEffectSuccess)
	{
		...
		if (!fn)
			fn = UObject::FindObject<UFunction>("Function TennisScramble_RaiseNet.TennisScramble_RaiseNet_C.ActivateScrambleEffect");
	 ...
	 * Function:
	 * 		RVA    -> 0x00669880
	 * 		Name   -> Function TennisScramble_RaiseNet.TennisScramble_RaiseNet_C.UserConstructionScript
	...
	void ATennisScramble_RaiseNet_C::UserConstructionScript()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>("Function TennisScramble_RaiseNet.TennisScramble_RaiseNet_C.UserConstructionScript");
	 ...
	 * Function:
	 * 		RVA    -> 0x00000000
	 * 		Name   -> PredefinedFunction ATennisScramble_RaiseNet_C.StaticClass
	 * 		Flags  -> (Predefined, Static)
	 */
	UClass* ATennisScramble_RaiseNet_C::StaticClass()
	{
		static UClass* ptr = nullptr;
		if (!ptr)
			ptr = UObject::FindClass("BlueprintGeneratedClass TennisScramble_RaiseNet.TennisScramble_RaiseNet_C");
		return ptr;
	}
