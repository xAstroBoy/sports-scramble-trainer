...
// BlueprintGeneratedClass TennisScramble_RaiseNet.TennisScramble_RaiseNet_C
...
public:
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass TennisScramble_RaiseNet.TennisScramble_RaiseNet_C");
		return ptr;
	}
