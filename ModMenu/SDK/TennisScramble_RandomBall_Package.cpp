...
namespace CG
{
	 ...
	 * Function:
	 * 		RVA    -> 0x00669880
	 * 		Name   -> Function TennisScramble_RandomBall.TennisScramble_RandomBall_C.GetNewBallType
	...
	class UClass* ATennisScramble_RandomBall_C::GetNewBallType()
	{
		...
		if (!fn)
			fn = UObject::FindObject<UFunction>("Function TennisScramble_RandomBall.TennisScramble_RandomBall_C.GetNewBallType");
	 ...
	 * Function:
	 * 		RVA    -> 0x00669880
	 * 		Name   -> Function TennisScramble_RandomBall.TennisScramble_RandomBall_C.GetRandomBall
	...
	void ATennisScramble_RandomBall_C::GetRandomBall(class UClass* BallClass, class UClass** NewBall)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>("Function TennisScramble_RandomBall.TennisScramble_RandomBall_C.GetRandomBall");
	 ...
	 * Function:
	 * 		RVA    -> 0x00669880
	 * 		Name   -> Function TennisScramble_RandomBall.TennisScramble_RandomBall_C.ActivateScrambleEffect
	 * 		Flags  -> (Public, HasOutParms, BlueprintCallable, BlueprintEvent)
	 * Parameters:
	...
	void ATennisScramble_RandomBall_C::ActivateScrambleEffect(class ATN_Ball_Base_C* Ball, class AActor* OtherActor, bool* ScrambleEffectSuccess)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>("Function TennisScramble_RandomBall.TennisScramble_RandomBall_C.ActivateScrambleEffect");
	 ...
	 * Function:
	 * 		RVA    -> 0x00669880
	 * 		Name   -> Function TennisScramble_RandomBall.TennisScramble_RandomBall_C.UserConstructionScript
	...
	void ATennisScramble_RandomBall_C::UserConstructionScript()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>("Function TennisScramble_RandomBall.TennisScramble_RandomBall_C.UserConstructionScript");
	 ...
	 * Function:
	 * 		RVA    -> 0x00000000
	 * 		Name   -> PredefinedFunction ATennisScramble_RandomBall_C.StaticClass
	 * 		Flags  -> (Predefined, Static)
	 */
	UClass* ATennisScramble_RandomBall_C::StaticClass()
	{
		static UClass* ptr = nullptr;
		if (!ptr)
			ptr = UObject::FindClass("BlueprintGeneratedClass TennisScramble_RandomBall.TennisScramble_RandomBall_C");
		return ptr;
	}
