...
namespace CG
{
	 ...
	 */
	struct ATennisScramble_RandomRacket_C_RacquetChanged_Params
	{
	public:
	 ...
	 */
	struct ATennisScramble_RandomRacket_C_GetRandomInstrument_Params
	{
	public:
	 ...
	 */
	struct ATennisScramble_RandomRacket_C_ActivateScrambleEffect_Params
	{
	public:
		...
		unsigned char                                              UnknownData_QQNL[0x7];                                   // 0x0011(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY) ()
	};

	/**
	 * Function TennisScramble_RandomRacket.TennisScramble_RandomRacket_C.UserConstructionScript
	 */
	struct ATennisScramble_RandomRacket_C_UserConstructionScript_Params
	{	};
