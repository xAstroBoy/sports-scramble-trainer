...
// BlueprintGeneratedClass TennisScramble_RandomRacket.TennisScramble_RandomRacket_C
...
public:
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass TennisScramble_RandomRacket.TennisScramble_RandomRacket_C");
		return ptr;
	}
