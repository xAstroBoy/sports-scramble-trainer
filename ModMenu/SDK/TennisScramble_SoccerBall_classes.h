...
// BlueprintGeneratedClass TennisScramble_SoccerBall.TennisScramble_SoccerBall_C
...
public:
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass TennisScramble_SoccerBall.TennisScramble_SoccerBall_C");
		return ptr;
	}
