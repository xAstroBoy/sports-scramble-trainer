...
// BlueprintGeneratedClass TennisScramble_TennisBall.TennisScramble_TennisBall_C
...
public:
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass TennisScramble_TennisBall.TennisScramble_TennisBall_C");
		return ptr;
	}
