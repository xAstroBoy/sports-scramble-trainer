...
namespace CG
{
	 ...
	 */
	struct ATennisScramble_TennisRacket_C_RacquetChanged_Params
	{
	public:
	 ...
	 */
	struct ATennisScramble_TennisRacket_C_GetRandomInstrument_Params
	{
	public:
	 ...
	 */
	struct ATennisScramble_TennisRacket_C_ActivateScrambleEffect_Params
	{
	public:
		...
		unsigned char                                              UnknownData_NMLT[0x7];                                   // 0x0011(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY) ()
	};

	/**
	 * Function TennisScramble_TennisRacket.TennisScramble_TennisRacket_C.UserConstructionScript
	 */
	struct ATennisScramble_TennisRacket_C_UserConstructionScript_Params
	{	};
