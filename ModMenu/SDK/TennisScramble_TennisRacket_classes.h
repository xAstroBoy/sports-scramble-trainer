...
// BlueprintGeneratedClass TennisScramble_TennisRacket.TennisScramble_TennisRacket_C
...
public:
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass TennisScramble_TennisRacket.TennisScramble_TennisRacket_C");
		return ptr;
	}
