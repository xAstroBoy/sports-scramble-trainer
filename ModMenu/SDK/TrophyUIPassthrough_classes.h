...
// 0x0024 (FullSize[0x0BAC] - InheritedSize[0x0B88])
...
public:
	...
	unsigned char                                      UnknownData_BE7V[0x6];                                     // 0x0B9A(0x0006) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass TrophyUIPassthrough.TrophyUIPassthrough_C");
		return ptr;
	}
	...
	void ExecuteUbergraph_TrophyUIPassthrough(int EntryPoint);
};
