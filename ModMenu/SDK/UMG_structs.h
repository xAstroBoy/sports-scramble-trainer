...
struct FEventReply
{
	unsigned char                                      UnknownData_K2ZZ[0xB8];                                    // 0x0000(0x00B8) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_L8NS[0x30];                                    // 0x0000(0x0030) MISSED OFFSET (PADDING)
...
struct FSlateChildSize
{
	...
	unsigned char                                      UnknownData_7XEU[0x3];                                     // 0x0005(0x0003) MISSED OFFSET (PADDING)
...
struct FWidgetAnimationBinding
{
	...
	unsigned char                                      UnknownData_EHW8[0x7];                                     // 0x0021(0x0007) MISSED OFFSET (PADDING)
...
struct FDelegateRuntimeBinding
{
	...
	unsigned char                                      UnknownData_KJX1[0x7];                                     // 0x0049(0x0007) MISSED OFFSET (PADDING)
...
struct FWidgetNavigationData
{
	...
	unsigned char                                      UnknownData_MMB7[0x7];                                     // 0x0001(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FMovieScene2DTransformSectionTemplate : public FMovieScenePropertySectionTemplate
{
	...
	unsigned char                                      UnknownData_8LFW[0x3];                                     // 0x04A9(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FMovieSceneMarginSectionTemplate : public FMovieScenePropertySectionTemplate
{
	...
	unsigned char                                      UnknownData_QKCN[0x7];                                     // 0x02C9(0x0007) MISSED OFFSET (PADDING)
